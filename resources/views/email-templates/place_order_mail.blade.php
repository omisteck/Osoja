                                ...
                                @if ($order->store)
                                    <div style="display:flex; align-items:center;margin-top:10px;">
                                        <img style="border:0;border-radius:50%;"
                                            ...
                                            title="Logo" class="sitelogo" width="20%" alt="Image" />
                        ...
                        <td style="width:100%;vertical-align: top;">
                            <div style="margin-top:10px;">
                                ...
                                <div style="margin-top: 10px; background: aliceblue;">
                                    ...
                                    <span
                                        style="color: {{ $order->payment_status == 'paid' ? 'green' : 'red' }}; width: 33.33%; display: inline-block;">
                                        {{ $order->payment_status }}
                                    </span>
                                    <span style="color: #414141 !important ; text-transform: capitalize;">
                                        {{ date('d M Y ' . config('timeformat'), strtotime($order['created_at'])) }}
                    ...
                    <tbody style="">
                        @if ($order->order_type == 'parcel')
                            <tr style="border-bottom: 1px ridge;text-transform: capitalize;">
                                ...
                                <th style="padding-bottom: 8px;width:50%;">{{ translate('messages.parcel_category') }}
                                </th>
                                <th style="padding-bottom: 8px;width:15%">{{ translate('messages.distance') }}</th>
                                <th style="padding-bottom: 8px;width:30%;">{{ translate('messages.delivery_charge') }}
                                </th>
                            </tr>
                            ...
                            <tr style="text-align: center; border-bottom: 1px ridge;">
                                ...
                                <td style="padding:5px;">
                                    ...
                                    <br>
                                    <span
                                        style="font-size: 12px;">{{ $order->parcel_category ? $order->parcel_category->description : translate('messages.parcel_category_not_found') }}</span>
                                </td>
                                <td style="padding:5px;"> {{ $order->distance }} {{ translate('messages.km') }} </td>
                                <td style="padding:5px;">
                                    {{ \App\CentralLogics\Helpers::format_currency($order->delivery_charge) }}</td>
                            </tr>
                        @else
                            <tr style="border-bottom: 1px ridge;text-transform: capitalize;">
                                <th style="padding-bottom: 8px;width:10%;">{{ translate('messages.sl') }}</th>
                                <th style="padding-bottom: 8px;width:40%;">{{ translate('messages.Ordered_Items') }}
                                </th>
                ...
                <td style="text-align: end">
                    <table style="width: 46%;margin-inline-start:41%; display: inline;text-transform: capitalize; ">
                        <tbody>
                            @if ($order->order_type != 'parcel')
                                <tr>
                                    <th><b>{{ translate('messages.item') }} {{ translate('messages.price') }} : </b>
                                    </th>
                                    <td>{{ \App\CentralLogics\Helpers::format_currency($sub_total) }}</td>
                                </tr>
                                <tr>
                                    <th><b>{{ translate('messages.addon') }} {{ translate('messages.cost') }} : </b>
                                    </th>
