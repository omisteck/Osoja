                    ...
                    <td>
                        <div style="text-align: end; margin-inline-end:15px;">
                            <img style="max-width:250px;border:0;"
                                src="{{ asset('/storage/app/public/business/' . $logo) }}" title="" class="sitelogo"
                                width="60%" alt="" />
                        </div>
                    </td>
                </tr>
                ...
                <tr style="width: 100%;">
                    <td style="width:50%;vertical-align: top; margin-top:5px;">
                        ...
                        <div style="text-align:start;margin-top:10px;">
                            <span
                                style="color: #130505 !important;text-transform: capitalize;font-weight: bold;">{{ translate('messages.restaurant') }}
                                {{ translate('messages.info') }} </span><br>
                            ...
                            @if ($order->restaurant)
                                <div style="display:flex; align-items:center;margin-top:10px;">
                                    ...
                                    <img style="border:0;border-radius:50%;"
                                        ...
                                        title="" class="sitelogo" width="20%" alt="" />
                ...
                <tr>
                    <th>
                        ...
                        <div style="font-weight: 400;font-size: 11px;line-height: 22px;color: #242A30;">
                            {{ $company_address }}</div>
                        <span
                            style="font-weight: 400;font-size: 10px;line-height: 22px;color: #242A30;">{{ translate('messages.All copy right reserved', ['year' => date('Y'), 'title' => $company_name]) }}</span>
                    </th>
                </tr>
