...
<body style="background-color: #ececec;margin:0;padding:0;text-align:center;">
    ...
    <div
        ...
        @if ($type)
            <span
                style="font-weight: 400;font-size: 14px;line-height: 135.5%;color: #182E4B;display:block; margin-bottom:34px;">{{ translate('Default login password: ') }}
                <span style="color: #EF7822;">password</span></span>
        @endif
                            ...
                            @foreach ($social_media as $item)
                                <div style="display:inline-block;">
                                    <a href="{{ $item->link }}" target=”_blank”>
                                        <img src="{{ asset('assets/admin/img/' . $item->name . '.png') }}"
