...
<head>
    ...
    <link rel="icon" type="image/x-icon"
        href="{{ asset('storage/business/' . $icon ?? asset('assets/landing/img/favicon.svg')) }}">
    @stack('css_or_js')
                ...
                <div class="navbar-bottom-wrapper">
                    ...
                    <ul class="menu me-lg-4">
                        ...
                        @if ($landing_page_links && $landing_page_links['web_app_url_status'])
                            <div class="mt-2">
                                <a class="cmn--btn me-xl-auto py-2" href="{{ $landing_page_links['web_app_url'] }}"
            ...
            <div class="container">
                <div class="newsletter-wrapper">
                    <div class="newsletter-content position-relative">
                        <h3 class="title">
                            {{ isset($landing_page_text['newsletter_title']) ? $landing_page_text['newsletter_title'] : '' }}
                        </h3>
                        <div class="text">
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="footer-wrapper ps-xl-5">
                                ...
                                @foreach ($social_media as $social)
                                    <li>
                                        <a href="{{ $social->link }}" target="_blank">
                                            <img src="{{ asset('assets/landing/img/footer/' . $social->name . '.svg') }}"
                                                alt="">
                                        </a>
                                    </li>
                                @endforeach
                        ...
                        @if (isset($landing_page_links['app_url_android_status']) || isset($landing_page_links['app_url_ios_status']))
                            <div class="app-btn-grp">
                                @if (isset($landing_page_links['app_url_android_status']))
                                    <a
                                        href="{{ isset($landing_page_links['app_url_android']) ? $landing_page_links['app_url_android'] : '' }}">
                                        <img src="{{ asset('assets/landing/img/google.svg') }}" alt="">
                                    </a>
                                @endif
                                @if (isset($landing_page_links['app_url_ios_status']))
                                    <a
                                        href="{{ isset($landing_page_links['app_url_ios']) ? $landing_page_links['app_url_ios'] : '' }}">
                    ...
                    <div class="footer-widget widget-links">
                        <h5 class="subtitle mt-2 text-white">{{ translate('messages.Contact') }}
                            {{ translate('messages.Us') }} </h5>
                        <ul>
                            <li>
                                <a>
