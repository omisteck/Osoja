            ...
            <div class="navbar-vertical-content bg--005555" id="navbar-vertical-content">
                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('deliveryman'))
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('admin/users/delivery-man/new') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('admin/users/delivery-man/list') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('admin/users/delivery-man/reviews/list') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('customerList'))
                        ...
                        <li
                            ...
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:"
                                title="{{ __('messages.customer_wallet') }}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display:{{ Request::is('admin/users/customer/wallet*') ? 'block' : 'none' }}">
                                <li
                        ...
                        <li
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display:{{ Request::is('admin/users/customer/loyalty-point*') ? 'block' : 'none' }}">
                                <li
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('admin/users/customer/settings') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{ route('admin.users.customer.settings') }}"
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('employee'))
                        <li
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li
                                    class="nav-item {{ Request::is('admin/users/employee/add-new') ? 'active' : '' }}">
