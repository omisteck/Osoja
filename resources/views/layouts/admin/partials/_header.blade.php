                ...
                <ul class="navbar-nav align-items-center flex-row flex-grow-1 __navbar-nav">
                        ...
                        <div class="__nav-module" id="tourb-4">
                            ...
                            <div class="__nav-module-body">
                                <ul>
                                    @if (\App\CentralLogics\Helpers::module_permission_check('module'))
                                        <li>
                                            <a href="{{ route('admin.business-settings.module.index') }}"
                                                onclick="next_tour()">
                                                <img src="{{ asset('/assets/admin/img/navbar-setting-icon/module.svg') }}"
                                                    alt="">
                                    ...
                                    @if (\App\CentralLogics\Helpers::module_permission_check('zone'))
                                        <li>
                                            <a href="{{ route('admin.business-settings.zone.home') }}"
                                                onclick="next_tour()">
                                                <img src="{{ asset('/assets/admin/img/navbar-setting-icon/location.svg') }}"
                                                    alt="">
                                    ...
                                    @if (\App\CentralLogics\Helpers::module_permission_check('settings'))
                                        <li>
                                            <a href="{{ route('admin.business-settings.business-setup') }}"
                                                onclick="next_tour()">
                                                <img src="{{ asset('/assets/admin/img/navbar-setting-icon/business.svg') }}"
                                                    alt="">
                                    ...
                                    @if (\App\CentralLogics\Helpers::module_permission_check('settings'))
                                        <li>
                                            <a href="{{ route('admin.business-settings.config-setup') }}"
                                                onclick="next_tour()">
                                                <img src="{{ asset('/assets/admin/img/navbar-setting-icon/third-party.svg') }}"
                                                    alt="">
                                        ...
                                        <li>
                                            <a href="{{ route('admin.business-settings.social-media.index') }}"
                                                onclick="next_tour()">
                                                <img src="{{ asset('/assets/admin/img/navbar-setting-icon/social.svg') }}"
                                                    alt="">
                                ...
                                <div class="text-center mt-2">
                                    <a href="{{ route('admin.business-settings.business-setup') }}"
                                        onclick="next_tour()">{{ translate('View All') }}</a>
                                </div>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="nav-item max-sm-m-0 ml-auto mr-lg-3">
                        <a class="btn btn-icon rounded-circle nav-msg-icon" href="{{ route('admin.message.list') }}">
                            ...
                            <?php
                            $message = \App\Models\Conversation::whereUserType('admin')
                    ...
                    <li class="nav-item __nav-item">
                        <a href="javascript:void(0)" class="__nav-link module--nav-icon" id="tourb-0">
                            @if ($mod)
                                <img src="{{ asset('storage/module') }}/{{ $mod->icon }}"
                                    onerror="this.src='{{ asset('/assets/admin/img/new-img/module-icon.svg') }}'"
                                ...
                                <div class="__nav-module-body">
                                    <div class="__nav-module-items">
                                        @foreach ($modules as $module)
                                            <a href="javascript:;"
                                                onclick="set_filter('{{ route('admin.dashboard') }}','{{ $module->id }}','module_id')"
                                                class="__nav-module-item {{ Config::get('module.current_module_id') == $module->id ? 'active' : '' }}">
                                                <div class="img">
                                        ...
                                        @if (\App\CentralLogics\Helpers::module_permission_check('module'))
                                            <a href="{{ route('admin.business-settings.module.create') }}"
                                                class="__nav-module-item" data-toggle="tooltip" data-placement="top"
                                                title="{{ translate('add_new_module') }}">
