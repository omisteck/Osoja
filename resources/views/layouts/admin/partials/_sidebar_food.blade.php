                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('pos'))
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/pos*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link "
                                href="{{ route('admin.pos.index') }}" title="{{ translate('New Sale') }}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li class="nav-item {{ Request::is('admin/campaign/item/*') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('admin.campaign.list', 'item') }}"
                                        title="{{ translate('messages.food') }} {{ translate('messages.campaigns') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                    ...
                    <li class="nav-item">
                        <small class="nav-subtitle"
                            title="{{ translate('messages.item') }} {{ translate('messages.section') }}">{{ translate('messages.food') }}
                            {{ translate('messages.management') }}</small>
                        <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                    </li>
                ...
                @endif --}}
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('item'))
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/item*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:"
                                title="{{ translate('Food Setup') }}">
                                <i class="tio-premium-outlined nav-icon"></i>
                                <span
                                    class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate text-capitalize">{{ translate('Food Setup') }}</span>
                            </a>
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('store'))
                        <li
                            ...
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                ...
                                title="{{ translate('messages.new_restaurants') }}">
                        ...
                        <li
                            ...
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                ...
                                title="{{ translate('add new restaurant') }}">
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('admin/store/list') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{ route('admin.store.list') }}"
                                title="{{ translate('messages.restaurants') }} {{ translate('messages.list') }}">
