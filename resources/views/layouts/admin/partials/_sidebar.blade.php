        ...
        <div class="navbar-vertical-container">
            ...
            <div class="navbar-vertical-content bg--005555" id="navbar-vertical-content">
                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    ...
                    <li class="nav-item">
                        <small class="nav-subtitle"
                            title="{{ translate('messages.module') }} {{ translate('messages.section') }}">{{ translate('messages.module_management') }}</small>
                        <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                    </li>
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('zone'))
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/zone*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{ route('admin.zone.home') }}" title="{{ translate('messages.zone_setup') }}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li class="nav-item {{ Request::is('admin/campaign/item/*') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('admin.campaign.list', 'item') }}"
                                        title="{{ translate('messages.item') }} {{ translate('messages.campaigns') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li
                                    ...
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                                        ...
                                        title="{{ translate('messages.add') }} {{ translate('messages.store') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">
                                ...
                                <li class="navbar-item {{ Request::is('admin/store/list') ? 'active' : '' }}">
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                                        ...
                                        title="{{ translate('messages.stores') }} {{ translate('messages.list') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                ...
                                <li
                                    ...
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                                        ...
                                        title="{{ translate('messages.pending') }} {{ translate('messages.requests') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span
