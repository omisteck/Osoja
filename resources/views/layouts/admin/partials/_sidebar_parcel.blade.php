        ...
        <div class="navbar-vertical-container">
            ...
            <div class="navbar-vertical-content bg--005555" id="navbar-vertical-content">
                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('order'))
                        ...
                        <li
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display:{{ Request::is('admin/parcel/orders/*') ? 'block' : 'none' }}">
                                ...
                                <li
                                    class="nav-item {{ Request::is('admin/parcel/orders/scheduled') ? 'active' : '' }}">
                                    <a class="nav-link" href="{{ route('admin.parcel.orders', ['scheduled']) }}"
                                ...
                                <li
                                    class="nav-item {{ Request::is('admin/parcel/orders/processing') ? 'active' : '' }}">
                                ...
                                <li
                                    class="nav-item {{ Request::is('admin/parcel/orders/delivered') ? 'active' : '' }}">
                                ...
                                <li
                                    class="nav-item {{ Request::is('admin/parcel/orders/canceled') ? 'active' : '' }}">
                                ...
                                <li
                                    class="nav-item {{ Request::is('admin/parcel/orders/refunded') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('admin.parcel.orders', ['refunded']) }}"
                        ...
                        <li
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li
                                    class="nav-item {{ Request::is('admin/parcel/dispatch/on_going') ? 'active' : '' }}">
                    ...
                    <li class="nav-item">
                        <small class="nav-subtitle"
                            title="{{ translate('messages.delivery') }} {{ translate('messages.section') }}">{{ translate('messages.delivery') }}
                            {{ translate('messages.management') }}</small>
                        <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                    </li>
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('parcel'))
                        <li
                            ...
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                ...
                                title="{{ translate('messages.delivery_fee_setup') }}">
