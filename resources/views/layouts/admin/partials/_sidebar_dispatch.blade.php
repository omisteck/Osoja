                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    ...
                    <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/dispatch') ? 'show active' : '' }}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link"
                            href="{{ route('admin.dispatch.dashboard') }}"
                    ...
                    <li class="nav-item">
                        <small class="nav-subtitle"
                            title="{{ translate('messages.dispatch') }} {{ translate('messages.section') }}">{{ translate('messages.dispatch') }}
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('order'))
                        ...
                        @foreach ($modules as $module)
                            @if ($module->module_type != 'parcel')
                                <li
                                    class="navbar-vertical-aside-has-menu {{ Request::is("admin/dispatch/list/{$module->id}*") ? 'active' : '' }}">
                                    <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                        href="javascript:" title="{{ $module->module_name }}">
                                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                            {{ $module->module_name }}
                                    ...
                                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                        ...
                                        <li
                                            class="nav-item {{ Request::is("admin/dispatch/list/{$module->id}/searching_for_deliverymen") ? 'active' : '' }}">
                                            <a class="nav-link "
                                                href="{{ route('admin.dispatch.list', [$module->id, 'searching_for_deliverymen']) }}"
                                        ...
                                        <li
                                            class="nav-item {{ Request::is("admin/dispatch/list/{$module->id}/on_going") ? 'active' : '' }}">
                                            <a class="nav-link "
                                                href="{{ route('admin.dispatch.list', [$module->id, 'on_going']) }}"
                            ...
                            @else
                                <li
                                    class="navbar-vertical-aside-has-menu {{ Request::is("admin/dispatch/parcel/list/{$module->id}*") ? 'active' : '' }}">
                                    <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                        href="javascript:" title="{{ $module->module_name }}">
                                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                            {{ $module->module_name }}
                                    ...
                                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                        style="{{ Request::is('admin/dispatch*') ? 'display-block' : 'display-none' }}">
                                        <li
                                            class="nav-item {{ Request::is("admin/dispatch/parcel/list/{$module->id}/searching_for_deliverymen") ? 'active' : '' }}">
                                            <a class="nav-link "
                                                href="{{ route('admin.dispatch.parcel.list', [$module->id, 'searching_for_deliverymen']) }}"
                                                title="{{ translate('messages.unassigned_orders') }}">
                                                <span class="tio-circle nav-indicator-icon"></span>
                                                <span class="text-truncate sidebar--badge-container">
                                                    {{ translate('messages.unassigned_orders') }}
                                        ...
                                        <li
                                            class="nav-item {{ Request::is("admin/dispatch/parcel/list/{$module->id}/on_going") ? 'active' : '' }}">
                                            <a class="nav-link "
                                                href="{{ route('admin.dispatch.parcel.list', [$module->id, 'on_going']) }}"
                                                title="{{ translate('messages.ongoingOrders') }}">
                                                <span class="tio-circle nav-indicator-icon"></span>
                                                <span class="text-truncate sidebar--badge-container">
                                                    {{ translate('messages.ongoingOrders') }}
