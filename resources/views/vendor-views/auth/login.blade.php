...
<body>
        ...
        <div class="auth-wrapper vendor-login">
            <div class="auth-wrapper-left">
                <div class="auth-left-cont">
                    ...
                    <img onerror="this.src='{{ asset('/assets/admin/img/favicon.png') }}'"
                        src="{{ asset('storage/business/' . $store_logo) }}" alt="public/img">
            ...
            <div class="auth-wrapper-right">
                ...
                <div class="auth-wrapper-form">
                    <div class="auth-header">
                        <div class="mb-5">
                            <h2 class="title signin-txt">{{ translate('messages.store') }}
                                {{ translate('messages.sign_in') }}</h2>
                    ...
                    <!-- Form -->
                    <form class="login_form" action="{{ route('vendor.auth.login') }}" method="post"
                        id="vendor_login_form" style="display: none;">
                        @csrf
                        ...
                        <div class="js-form-message form-group">
                            ...
                            <div class="input-group input-group-merge">
                                <input type="password" class="js-toggle-password form-control form-control-lg"
                                    ...
                                    placeholder="{{ translate('messages.password_length_placeholder', ['length' => '5+']) }}"
                            ...
                            <div class="row p-2">
                                <div class="col-6 pr-0">
                                    <input type="text" class="form-control form-control-lg" name="custome_recaptcha"
                                        ...
                                        placeholder="{{ \translate('Enter recaptcha value') }}" style="border: none"
                                        autocomplete="off">
                                </div>
                        ...
                        <div class="toggle-login">
                            {{ translate('Login as Store Employee') }}? <span class="toggle-login-btn text-yellow"
                                data-type="emloyee"
                                target-login="Store Employee Sign in">{{ translate('login here') }}</span>
                        </div>
                    </form>
                    <!-- End Form -->
                    <!-- Form -->
                    <form class="login_form" action="{{ route('vendor.auth.employee.login') }}" method="post"
                        id="employee_login_form" style="display: none;">
                        @csrf
                        <!-- Form Group -->
                        <div class="js-form-message form-group">
                            <label class="input-label"
                            ...
                            <input type="email" class="form-control form-control-lg" name="email" tabindex="1"
                            ...
                            <div class="row p-2">
                                <div class="col-6 pr-0">
                                    <input type="text" class="form-control form-control-lg"
                                        name="custome_recaptcha2"
                                        value="{{ env('APP_MODE') == 'dev' ? session('six_captcha') : '' }}"
                                        id="custome_recaptcha2" required
                                        placeholder="{{ \translate('Enter recaptcha value') }}" style="border: none"
                                        autocomplete="off">
                                </div>
                                <div class="col-6" style="background-color: #FFFFFF; border-radius: 5px;">
                        ...
                        <div class="toggle-login">
                            {{ translate('Login as Store Owner') }}? <span class="toggle-login-btn text-yellow"
                                data-type="emloyee"
                                target-login="Store Owner Sign in">{{ translate('messages.login here') }}</span>
                        </div>
    ...
    <script>
        ...
        $('#owner_sign_in').on('click', function() {
            ...
            $('.signin-txt').text(
                "{{ translate('messages.store') }} {{ translate('owner') }} {{ translate('messages.sign_in') }}"
            )
        });
        $('#employee_sign_in').on('click', function() {
            ...
            $('#vendor_login_form').hide();
            $('.signin-txt').text(
                "{{ translate('messages.store') }} {{ translate('employee') }} {{ translate('messages.sign_in') }}"
            )
        });
