            ...
            <form class="js-validate" action="{{ route('restaurant.store') }}" method="post" enctype="multipart/form-data"
                ...
                <div class="card __card mb-3">
                    <div class="card-header">
                        <h5 class="card-title">
                            <svg width="20" x="0" y="0" viewBox="0 0 68 68"
                            ...
                            </svg> {{ translate('messages.store') }} {{ translate('messages.info') }}
                        </h5>
                    </div>
                            ...
                            <div class="col-md-6 col-lg-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" name="minimum_delivery_time"
                                        ...
                                        <select name="delivery_time_type"
                                            class="form-control __form-control text-capitalize" id="" required>
                        ...
                        <div class="row row-margin-top">
                            <div class="col-md-6 col-lg-6 col-sm-12 float-end">
                                <div class="form-group">
                                    ...
                                    <label for="name" class="input-label pt-2">{{ translate('messages.upload') }}
                            ...
                            <div class="col-md-6 col-lg-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <img class="__register-img" id="logoImageViewer"
                                        src="{{ asset('assets/admin/img/160x160/img1.jpg') }}" alt="Product thumbnail" />
                ...
                <div class="card __card mb-3">
                    <div class="card-header">
                        <h5 class="card-title">
                            <svg width="20" x="0" y="0" viewBox="0 0 460.8 460.8"
                                style="enable-background:new 0 0 512 512" xml:space="preserve" class="">
                                <g>
                                    <g>
                                        <g>
                        ...
                        <div class="row row-margin-top">
                            ...
                            <div class="col-md-4 col-lg-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="phone" class="form-control __form-control"
                            ...
                            <div class="col-md-4 col-sm-12 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="password" name="password"
                                        ...
                                        minlength="6" id="exampleInputPassword" required value="{{ old('password') }}">
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-12 col-lg-4">
                                <div class="form-group">
                                        ...
                                        <div class="row p-2">
                                            <div class="col-6 pr-0">
                                                <input type="text" class="form-control" name="custome_recaptcha"
                                                    ...
                                                    placeholder="{{ \__('Enter recaptcha value') }}" autocomplete="off"
                ...
                <div class="text-end">
                    <button type="submit"
                        class="cmn--btn rounded-md border-0 outline-0">{{ translate('messages.submit') }}</button>
                </div>
            </form>
        </div>
    </section>
