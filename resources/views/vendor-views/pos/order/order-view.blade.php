                            ...
                            <div class="col-6 pt-2">
                                <div class="text-right">
                                    ...
                                    <h6 class="text-capitalize color-8a8a8a">{{ translate('messages.order') }}
                                        ...
                                        : <label
                                            class="badge fz-10px badge-soft-primary">{{ str_replace('_', ' ', $order['order_type']) }}</label>
                                    </h6>
                                    @if ($order->schedule_at && $order->scheduled)
                                        <h6 class="text-capitalize color-8a8a8a">{{ translate('messages.scheduled_at') }}
                                            : <label
                                                class="badge fz-10px badge-soft-primary">{{ date('d M Y ' . config('timeformat'), strtotime($order['schedule_at'])) }}</label>
                                        </h6>
                                    @endif
                                </div>
                            </div>
                        ...
                        <div class="row justify-content-md-end mb-3">
                            <div class="col-md-9 col-lg-8">
                                <dl class="row text-sm-right">
                                    ...
                                    <dd class="col-sm-6">{{ \App\CentralLogics\Helpers::format_currency($sub_total) }}
                                    </dd>
                                    ...
                                    <dd class="col-sm-6">
                                        {{ \App\CentralLogics\Helpers::format_currency($sub_total + $del_c + $order['total_tax_amount'] + $add_ons_cost - $order['coupon_discount_amount'] - $order['store_discount_amount']) }}
                                    </dd>
                                </dl>
                                <!-- End Row -->
                            </div>
