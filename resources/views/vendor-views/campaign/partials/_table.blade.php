    ...
    <tr>
        ...
        <td class="text-center">
            ...
            @if (in_array($store_id, $store_ids))
                ...
                <form action="{{ route('vendor.campaign.remove-store', [$campaign['id'], $store_id]) }}" method="GET"
            ...
            @else
                ...
                <form action="{{ route('vendor.campaign.add-store', [$campaign['id'], $store_id]) }}" method="GET"
                    id="campaign-{{ $campaign['id'] }}">
                    @csrf
                </form>
            @endif
