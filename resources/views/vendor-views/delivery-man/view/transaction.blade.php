                    ...
                    <form action="javascript:" id="search-form" class="search-form">
                        ...
                        <div class="input-group input--group">
                            <input id="datatableSearch_" type="search" name="search" class="form-control"
                                placeholder="{{ translate('messages.ex_search_order_id ') }}" aria-label="Search">
                    ...
                    <table id="datatable"
                        ...
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="border-0">{{ translate('messages.deliveryman') }}
                        ...
                        <tbody id="set-rows">
                            ...
                            @foreach ($digital_transaction as $k => $dt)
                                <tr>
                                    ...
                                    <td><a
                                            href="{{ route('vendor.order.details', $dt->order_id) }}">{{ $dt->order_id }}</a>
                                    </td>
