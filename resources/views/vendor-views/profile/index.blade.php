                        ...
                        <div class="card-body">
                            ...
                            <div class="row form-group">
                                <label for="firstNameLabel"
                                    class="col-sm-3 col-form-label input-label">{{ translate('messages.full_name') }} <i
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="button"
                                    onclick="@if (env('APP_MODE') != 'demo') form_alert('vendor-settings-form','{{ translate('messages.you_want_to_update_user_info') }}') @else call_demo() @endif"
                ...
                <div id="passwordDiv" class="card mb-3 mb-lg-5">
                    ...
                    <div class="card-body">
                        ...
                        <form id="changePasswordForm"
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="button"
                                    onclick="@if (env('APP_MODE') != 'demo') form_alert('changePasswordForm', '{{ translate('messages.want_to_update_password') }}') @else call_demo() @endif"
                                    class="btn btn--primary">{{ translate('messages.save_changes') }}</button>
                            </div>
                        </form>
                        <!-- End Form -->
