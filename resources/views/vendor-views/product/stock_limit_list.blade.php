            ...
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-filter-list"></i>
                        {{ translate('messages.stock_limit_list') }}<span class="badge badge-soft-dark ml-2"
                ...
                @if ($toggle_veg_non_veg)
                    ...
                    <div class="col-sm-auto mb-1 mb-sm-0">
                        <select name="category_id" onchange="set_filter('{{ url()->full() }}',this.value, 'type')"
                            data-placeholder="{{ translate('messages.all') }}" class="form-control h--37px">
                ...
                <div class="col-sm-auto">
                    <a href="{{ route('vendor.item.add-new') }}"
                        class="btn btn--primary m-0 pull-right h--37px d-flex align-items-center justify-content-center"><i
                            class="tio-add-circle"></i> {{ translate('messages.add') }} {{ translate('messages.new') }}
                        {{ translate('messages.item') }}</a>
                </div>
