    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="btn--container align-items-center mb-0">
                <div class="mr-auto">
                    <h1 class="page-header-title"><i class="tio-filter-list"></i> {{ translate('messages.item') }}
                ...
                @if ($store_data->module->module_type == 'food' && $toggle_veg_non_veg)
                    ...
                    <div>
                        <select name="category_id" onchange="set_filter('{{ url()->full() }}',this.value, 'type')"
                            data-placeholder="{{ translate('messages.all') }}" class="form-control max-lg-h-40px">
                            ...
                            <tr>
                                ...
                                <td>
                                    <label class="toggle-switch toggle-switch-sm"
                                        ...
                                        <input type="checkbox"
                                            onclick="location.href='{{ route('vendor.item.status', [$item['id'], $item->status ? 0 : 1]) }}'"class="toggle-switch-input"
                                ...
                                <td>
                                    <div class="btn--container justify-content-center">
                                        ...
                                        <a class="btn btn-sm btn--danger btn-outline-danger action-btn" href="javascript:"
                                            onclick="form_alert('food-{{ $item['id'] }}','Want to delete this item ?')"
