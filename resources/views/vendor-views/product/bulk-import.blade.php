    ...
    <div class="content container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="jumbotron pt-1 mb-0 pb-4 bg-white">
                    ...
                    <p>{{ translate('4. You can get store id, module id and unit id from their list, please input the right ids.') }}
                    </p>

                    <p>{{ translate('5. For ecommerce item avaliable time start and end will be 00:00:00 and 23:59:59') }}
                    </p>

                    <p>{{ translate('6. You can upload your product images in product folder from gallery, and copy image`s path.') }}
                    </p>
                ...
                <div class="text-center pb-4">
                    ...
                    <div class="btn--container justify-content-center export--template-btns">
                        <a href="{{ asset('assets/restaurant_panel/items_bulk_format.xlsx') }}" download=""
                            class="btn btn-dark">{{ translate('template_with_existing_data') }}</a>
                        <a href="{{ asset('assets/restaurant_panel/items_bulk_format_nodata.xlsx') }}" download=""
        ...
        <form class="product-form" action="{{ route('vendor.item.bulk-import') }}" method="POST"
            ...
            <div class="card mt-2 rest-part">
                <div class="card-body">
                    <h4 class="mb-3">{{ translate('messages.Import Item`s File') }}</h4>
