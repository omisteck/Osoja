                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="form-group mb-0">
                                    <label
                                        ...
                                        <input type="checkbox" class="toggle-switch-input"
                                            onclick="location.href='{{ route('vendor.business-settings.toggle-settings', [$store->id, $store->prescription_order ? 0 : 1, 'prescription_order']) }}'"
                            ...
                            <div class="form-group m-0">
                                <label
                                    ...
                                    <input type="checkbox" name="free_delivery" class="toggle-switch-input"
                                        onclick="location.href='{{ route('vendor.business-settings.toggle-settings', [$store->id, $store->free_delivery ? 0 : 1, 'free_delivery']) }}'"
                    ...
                    <div class="row">
                        <div class="form-group mb-0 col-md-4">
                            ...
                            <input type="number" name="minimum_order" step="0.01" min="0" max="100000"
                                class="form-control" placeholder="100" value="{{ $store->minimum_order ?? '0' }}">
                        </div>
                        @if (config('module.' . $store->module->module_type)['order_place_to_schedule_interval'])
                            <div class="form-group mb-0 col-md-4">
                                ...
                                <input type="text" name="order_place_to_schedule_interval" class="form-control"
                        ...
                        <div class="form-group mb-0 col-md-4">
                            ...
                            <div class="input-group">
                                <input type="number" name="minimum_delivery_time" class="form-control"
                                    placeholder="Min: 10" value="{{ explode('-', $store->delivery_time)[0] }}"
                            ...
                            <div class="col-sm-{{ $store->self_delivery_system ? '4' : '6' }} col-12">
                                <div class="form-group mt-3">
                                    ...
                                    <input type="number" id="minimum_shipping_charge" min="0" max="99999999.99"
                                        ...
                                        value="{{ isset($store->minimum_shipping_charge) ? $store->minimum_shipping_charge : '' }}">
                                </div>
                            </div>
                        ...
                        {{-- <div class="col-sm-{{$store->self_delivery_system?'4':'6'}}">
                            <div class="form-group mb-0 p-2 border">
                                <label class="d-flex justify-content-between switch toggle-switch-sm text-dark" for="gst_status">
                                    <span>{{translate('messages.gst')}} <span class="input-label-secondary" title="{{translate('messages.gst_status_warning')}}"><img src="{{asset('/assets/admin/img/info-circle.svg')}}" alt="{{translate('messages.gst_status_warning')}}"></span></span>
