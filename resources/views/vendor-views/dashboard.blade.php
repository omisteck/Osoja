            ...
            <div class="row gx-2 gx-lg-3">
                                ...
                                <div class="col-sm mb-2 mb-sm-0">
                                    <div class="d-flex flex-wrap justify-content-center align-items-center">
                                        ...
                                        <span class="h5 m-0 mr-3 fz--11 d-flex align-items-center mb-2 mb-md-0">
                                            ...
                                            <span>{{ \App\CentralLogics\Helpers::format_currency(array_sum($earning)) }}</span>
                                        </span>
                                        <span class="h5 m-0 fz--11 d-flex align-items-center mb-2 mb-md-0">
                                            <span class="legend-indicator chart-bg-3"></span>
                                            {{ translate('messages.commission_given') }} :
                                            <span>{{ \App\CentralLogics\Helpers::format_currency(array_sum($commission)) }}</span>
                                        </span>
                                    </div>
                ...
                <div class="col-lg-6 mt-3">
                    ...
                    <div class="card h-100" id="top-selling-items-view">
                        @include('vendor-views.partials._top-selling-items', [
                ...
                <div class="col-lg-6 mt-3">
                    ...
                    <div class="card h-100" id="top-rated-items-view">
                        @include('vendor-views.partials._most-rated-items', [
                            'most_rated_items' => $data['most_rated_items'],
                        ])
                    </div>
                    <!-- End Card -->
                </div>
