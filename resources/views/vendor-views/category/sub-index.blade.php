    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-header-title">
                ...
                <span>
                    {{ translate('messages.sub_category') }} <span class="badge badge-soft-dark ml-2"
                            ...
                            <form action="javascript:;" id="search-form" class="search-form min--280">
                                ...
                                <div class="input-group input--group">
                                    <input id="datatableSearch" type="search" name="search" class="form-control"
                                        placeholder="{{ translate('messages.ex_:_search_sub_category') }}"
                            ...
                            <div class="hs-unfold mr-2">
                                ...
                                <div id="usersExportDropdown"
                                    ...
                                    <a id="export-excel" class="dropdown-item"
                                        href="{{ route('vendor.category.export-sub-categories', ['type' => 'excel']) }}">
                                        <img class="avatar avatar-xss avatar-4by3 mr-2"
                                    ...
                                    <a id="export-csv" class="dropdown-item"
                                        href="{{ route('vendor.category.export-sub-categories', ['type' => 'csv']) }}">
                                        <img class="avatar avatar-xss avatar-4by3 mr-2"
                            ...
                            <table id="columnSearchDatatable"
                                ...
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th class="border-0">{{ translate('messages.main') }}
                                            {{ translate('messages.category') }}</th>
