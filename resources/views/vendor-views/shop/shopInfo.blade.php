    ...
    <div class="content container-fluid">
        ...
        <div class="card border-0">
            <div class="card-body p-0">
                @if ($shop->cover_photo)
                    <div>
                        <img class="my-restaurant-img" src="{{ asset('storage/store/cover/' . $shop->cover_photo) }}"
                ...
                <div class="my-resturant--card">
                    ...
                    @if ($shop->image == 'def.png')
                        <div class="my-resturant--avatar">
                            <img class="border" src="{{ asset('assets/back-end') }}/img/shop.png"
                                onerror="this.src='{{ asset('assets/admin/img/160x160/img1.jpg') }}'" alt="User Pic">
                        </div>
                    @else
                        <div class="my-resturant--avatar">
                            <img src="{{ asset('storage/store/' . $shop->logo) }}" class="border"
