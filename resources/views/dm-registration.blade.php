    ...
    <section class="about-section py-5 position-relative">
        <div class="container">
            ...
            <div class="section-header">
                <h2 class="title mb-2">{{ translate('messages.Deliveryman') }} <span
            ...
            <form action="{{ route('deliveryman.store') }}" method="post" enctype="multipart/form-data" id="form-id">
                ...
                <div class="card __card mb-3">
                    <div class="card-header">
                        <h5 class="card-title">
                            ...
                            </svg>{{ translate('messages.deliveryman') }} {{ translate('messages.info') }}
                        </h5>
                    </div>
                    <div class="card-body">
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="password" class="form-control __form-control"
                                        placeholder="{{ translate('messages.Ex:') }} password"
                ...
                <div class="text-end">
                    <button type="submit"
                        class="cmn--btn border-0 outline-0">{{ translate('messages.submit') }}</button>
                </div>
            </form>
        </div>
