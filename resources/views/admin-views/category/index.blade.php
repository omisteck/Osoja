                            ...
                            <div class="h-100 d-flex flex-column">
                                ...
                                <center class="py-3 my-auto">
                                    <img class="img--100" id="viewer"
                                        ...
                                        @else
                                        src="{{ asset('assets/admin/img/900x400/img1.jpg') }}" @endif
                                        alt="image" />
                                </center>
        ...
        <div class="card mt-3">
            <div class="card-header py-2 border-0">
                <div class="search--button-wrapper">
                    <h5 class="card-title">{{ translate('messages.category') }} {{ translate('messages.list') }}<span
                    ...
                    <form id="dataSearch" class="search-form">
                        ...
                        <div class="input-group input--group">
                            <input type="search" name="search" class="form-control min-height-45"
                    ...
                    <div class="hs-unfold mr-2">
                        ...
                        <div id="usersExportDropdown"
                            ...
                            <a id="export-excel" class="dropdown-item"
                                href="{{ url('/') }}/admin/category/export-categories/excel?{{ parse_url(url()->full(), PHP_URL_QUERY) }}">
                                <img class="avatar avatar-xss avatar-4by3 mr-2"
                                    src="{{ asset('assets/admin') }}/svg/components/excel.svg" alt="Image Description">
                                {{ translate('messages.excel') }}
                            </a>
                            <a id="export-csv" class="dropdown-item"
                                href="{{ url('/') }}/admin/category/export-categories/csv?{{ parse_url(url()->full(), PHP_URL_QUERY) }}">
                                <img class="avatar avatar-xss avatar-4by3 mr-2"
