        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="pt-1 mb-0 pb-4 bg-white">
                    ...
                    <p> {{ translate('4. After uploading categories you need to edit them and set category`s images.') }}
                    </p>
                    ...
                    <p> {{ translate('7. For a category parent_id will be empty, for sub category it will be the category id.') }}
                    </p>
