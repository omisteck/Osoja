...
@section('content')
    <div class="content container-fluid">
        ...
        <!-- Page Heading -->
        <!-- Content Row -->
        <form action="{{ route('admin.users.employee.update', [$e['id']]) }}" method="post" enctype="multipart/form-data"
            class="js-validate">
            @csrf
                        ...
                        <div class="col-md-8">
                            <div class="row g-3">
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" name="f_name" value="{{ $e['f_name'] }}" class="form-control"
                                        id="f_name" placeholder="{{ translate('messages.first_name') }}" required>
                                </div>
                                <div class="col-sm-6">
                                    <label class="input-label qcont" for="name">{{ translate('messages.last') }}
                                        {{ translate('messages.name') }}</label>
                                    <input type="text" name="l_name" value="{{ $e['l_name'] }}" class="form-control"
                                        id="l_name" placeholder="{{ translate('messages.last_name') }}">
                                </div>
                                <div class="col-sm-6">
                                    <div>
                        ...
                        <div class="col-md-4">
                            <label class="h-100 d-flex flex-column">
                                ...
                                <div class="custom-file">
                                    ...
                                    <span class="custom-file-label">{{ translate('messages.choose') }}
                                        {{ translate('messages.file') }}</span>
                                </div>
                            </label>
                        </div>
                    </div>
