                                ...
                                <div class="col-sm-6 col-md-4 col-xl-3">
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="number" name="admin_comission_in_delivery_charge"
                                            class="form-control" id="admin_comission_in_delivery_charge" min="0"
                                            max="100" step="0.01"
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title"> <span class="card-header-icon mr-2"><i class="tio-poi"></i></span>
                                <span>{{ translate('Company Location') }}</span>
                            </h4>
                        </div>
                        <div class="card-body">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="form-group mb-0">
                                                ...
                                                <textarea type="text" id="address" name="address" class="form-control h--70px" placeholder="" rows="1"
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title m-0 d-flex align-items-center"> <span class="card-header-icon mr-2"><i
                                ...
                                <span>{{ translate('business_information') }}</span>
                            </h4>
                        </div>
                        <div class="card-body">
                            <div class="row g-3">
                                            ...
                                            <span class="pr-1 d-flex align-items-center switch--label">
                                                ...
                                                <span class="form-label-secondary text-danger d-flex"
                                                    ...
                                                    data-original-title="{{ translate('When this field is active, store will get prescription order option.') }}"><img
                                                        src="{{ asset('/assets/admin/img/info-circle.svg') }}"
                                                        alt="{{ translate('messages.prescription_order_status') }}"> *
                                                </span>
                                            </span>
                                            <input type="checkbox" class="toggle-switch-input" value="1"
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="form-group mb-0">
                                        <label
                                            class="toggle-switch toggle-switch-sm d-flex justify-content-between border rounded px-3 px-xl-4 form-control">
                                            <span class="pr-2 d-flex align-items-center"><span
                                                    class="line--limit-1">{{ translate('Include_TAX_Amount') }}</span><span
                                                    class="input-label-secondary text--title" data-toggle="tooltip"
                                                    data-placement="right"
                                                    data-original-title="{{ translate('When this field is active, Tax amount will not be added with the total product price') }}">
                                                    <i class="tio-info-outined"></i>
                                                </span></span>
                                            <input type="checkbox" class="toggle-switch-input" value="1"
                                                name="tax_included" {{ $tax_included == 1 ? 'checked' : '' }}>
                                            <span class="toggle-switch-label text">
                                                <span class="toggle-switch-indicator"></span>
                                            </span>
                                        </label>
                ...
                <div class="col-lg-6">
                    <div class="card h-100">
                        <div class="card-header">
                            <h4 class="card-title m-0 d-flex align-items-center"> <span class="card-header-icon mr-2"><i
                                        class="tio-poi"></i></span>
                                <span>{{ translate('Office Opening & Closing') }}</span>
                            </h4>
                        </div>
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="time" value="{{ $opening_time ? $opening_time->value : '' }}"
                                            name="opening_time" class="form-control" id="opening_time">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="time" value="{{ $closing_time ? $closing_time->value : '' }}"
                                            name="closing_time" class="form-control" id="closing_time">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <select name="opening_day" class="form-control">
                                            ...
                                            <option value="wednesday"
                                                {{ $opening_day == 'wednesday' ? 'selected' : '' }}>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <select name="closing_day" class="form-control">
                                            ...
                                            <option value="wednesday"
                                                {{ $closing_day == 'wednesday' ? 'selected' : '' }}>
                                                {{ translate('messages.wednesday') }}
                                            </option>
