                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    <div class="form-group mb-0">
                                        <label
                                            ...
                                            <span class="pr-2">{{ translate('messages.customer_loyalty_point') }}
                                                :</span>
                                            <input type="checkbox" class="toggle-switch-input"
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    <div class="form-group mb-0">
                                        <label
                                            class="toggle-switch toggle-switch-sm d-flex justify-content-between border border-secondary rounded px-4 form-control">
                                            <span class="pr-2">{{ translate('messages.customer_referrer_earning') }}
                                                :</span>
                                            <input type="checkbox" class="toggle-switch-input"
                                                onclick="section_visibility('ref_earning_status')" name="ref_earning_status"
                                                id="ref_earning_status" data-section="referrer-earning" value="1"
                                    ...
                                    <div class="form-group mb-0">
                                        <label
                                            ...
                                            <span class="pr-2">{{ translate('messages.refund_to_wallet') }}<span
                                                    ...
                                                    data-original-title="{{ translate('messages.refund_to_wallet_hint') }}"><img
                                    ...
                                    <div class="form-group mb-0">
                                        <label class="input-label"
                                            ...
                                            <small class="text-danger"><span class="input-label-secondary"
                                                    ...
                                                    data-original-title="{{ translate('messages.item_purchase_point_hint') }}"><img
                                                        src="{{ asset('/assets/admin/img/info-circle.svg') }}"
                                                        alt="{{ translate('messages.item_purchase_point_hint') }}"></span>
                                                *</small>
                                        </label>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="number" class="form-control" name="minimun_transfer_point"
                                            min="0" value="{{ $data['loyalty_point_minimum_point'] ?? '0' }}">
                                    </div>
                                </div>
                            </div>
                        </div>
