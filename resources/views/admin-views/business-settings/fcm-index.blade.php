    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-header-title">
                ...
                <span>{{ translate('messages.firebase') }} {{ translate('messages.push') }}
                    {{ translate('messages.notification') }} {{ translate('messages.setup') }}
                </span>
            </h1>
        </div>
        <!-- End Page Header -->
        <div class="card mb-3">
            <div class="card-body">
                <form action="{{ env('APP_MODE') != 'demo' ? route('admin.business-settings.update-fcm') : 'javascript:' }}"
                    method="post" enctype="multipart/form-data">
                    @csrf
                    @php($key = \App\Models\BusinessSetting::where('key', 'push_notification_key')->first())
                    <div class="form-group">
                        <label class="input-label" for="exampleFormControlInput1">{{ translate('messages.server') }}
                            {{ translate('messages.key') }}</label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="d-flex">
                            <input type="text" value="{{ $project_id->value ?? '' }}" name="projectId"
                                class="form-control" placeholder="{{ translate('messages.Ex:') }} Project Id">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="input-label"
                            for="exampleFormControlInput1">{{ translate('messages.api_key') }}</label>
                        <div class="d-flex">
                            <input type="text"
                                value="{{ isset($fcm_credentials['apiKey']) ? $fcm_credentials['apiKey'] : '' }}"
                                name="apiKey" class="form-control" placeholder="{{ translate('messages.Ex:') }} Api key">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="input-label"
                            for="exampleFormControlInput1">{{ translate('messages.auth_domain') }}</label>
                        <div class="d-flex">
                            <input type="text"
                                value="{{ isset($fcm_credentials['authDomain']) ? $fcm_credentials['authDomain'] : '' }}"
                                name="authDomain" class="form-control"
                                placeholder="{{ translate('messages.Ex:') }} Auth domain">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="input-label"
                            for="exampleFormControlInput1">{{ translate('messages.storage_bucket') }}</label>
                        <div class="d-flex">
                            <input type="text"
                                value="{{ isset($fcm_credentials['storageBucket']) ? $fcm_credentials['storageBucket'] : '' }}"
                                name="storageBucket" class="form-control"
                                placeholder="{{ translate('messages.Ex:') }} Storeage bucket">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="input-label"
                            for="exampleFormControlInput1">{{ translate('messages.messaging_sender_id') }}</label>
                        <div class="d-flex">
                            <input type="text"
                                value="{{ isset($fcm_credentials['messagingSenderId']) ? $fcm_credentials['messagingSenderId'] : '' }}"
                                name="messagingSenderId" class="form-control"
                                placeholder="{{ translate('messages.Ex:') }} Messaging sender id">
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="input-label"
                            for="exampleFormControlInput1">{{ translate('messages.app_id') }}</label>
                        <div class="d-flex">
                            <input type="text"
                                value="{{ isset($fcm_credentials['appId']) ? $fcm_credentials['appId'] : '' }}"
                    ...
                    <div class="form-group">
                        <label class="input-label"
                            for="exampleFormControlInput1">{{ translate('messages.measurement_id') }}</label>
                        <div class="d-flex">
                            <input type="text"
                                value="{{ isset($fcm_credentials['measurementId']) ? $fcm_credentials['measurementId'] : '' }}"
                                name="measurementId" class="form-control"
                                placeholder="{{ translate('messages.Ex:') }} Measurement Id">
                        </div>
                    </div>
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-4 mb-5">
                        <select name="module_type" class="form-control js-select2-custom"
                            onchange="set_filter('{{ url()->full() }}',this.value,'module_type')"
                    ...
                    @if ($language)
                        ...
                        @foreach (json_decode($language) as $lang_key => $lang)
                            <div class="{{ $lang != $default_lang ? 'd-none' : '' }} lang_form"
                                ...
                                <div class="row">
                                    <?php
                                    $opm = \App\Models\NotificationMessage::with('translations')
                                        ->where('module_type', $mod_type)
                                        ->where('key', 'order_pending_message')
                                        ->first(); ?>
                                        ...
                                        <div class="form-group">
                                            <div class="d-flex flex-wrap justify-content-between mb-2">
                                                <span class="d-block text--semititle">
                                                    {{ translate('messages.order') }} {{ translate('messages.pending') }}
                                                    {{ translate('messages.message') }} ({{ strtoupper($lang) }})
                                                </span>
                                                @if ($lang == 'en')
                                                    <label
                                                        class="switch--custom-label toggle-switch d-flex align-items-center"
                                                        for="pending_status">
                                                        <input type="checkbox" name="pending_status"
                                                            class="toggle-switch-input"
                                                            @if ($lang == 'en') onchange="add_required_attribute('pending_status', 'pending_messages')" @endif
                                                        ...
                                                        <span
                                                            class="pl-2 switch--custom-label-text text-primary on text-uppercase">{{ translate('messages.on') }}</span>
                                                        <span
                                                            class="pl-2 switch--custom-label-text off text-uppercase">{{ translate('messages.off') }}</span>
                                                    </label>
                                                @endif
                                            </div>
                                            <textarea name="pending_message[]" class="form-control pending_messages"
                                    ...
                                    <?php
                                    $ocm = \App\Models\NotificationMessage::with('translations')
                                        ->where('module_type', $mod_type)
                                        ->where('key', 'order_confirmation_msg')
                                        ->first(); ?>
                                    @php($data = $ocm ? $ocm : '')
                                    <?php
                                        ...
                                        <div class="form-group">
                                            <div class="d-flex flex-wrap justify-content-between mb-2">
                                                <span class="d-block text--semititle">
                                                    ...
                                                    {{ translate('messages.confirmation') }}
                                            ...
                                            <textarea name="confirm_message[]" class="form-control confirm_message"
                                                oninvalid="document.getElementById('en-link').click()"
                                    ...
                                    @if ($mod_type != 'parcel')
                                        <?php
                                        $oprm = \App\Models\NotificationMessage::with('translations')
                                            ->where('module_type', $mod_type)
                                            ->where('key', 'order_processing_message')
                                            ->first(); ?>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                    ...
                                                    @if ($lang == 'en')
                                                        <label
                                                            ...
                                                            <input type="checkbox" name="processing_status"
                                                                class="toggle-switch-input"
                                                                onchange="add_required_attribute('processing_status', 'processing_message')"
                                                ...
                                                <textarea name="processing_message[]" class="form-control processing_message"
                                                    oninvalid="document.getElementById('en-link').click()"
                                        ...
                                        <?php
                                        $dbs = \App\Models\NotificationMessage::with('translations')
                                            ->where('module_type', $mod_type)
                                            ->where('key', 'order_handover_message')
                                            ->first(); ?>
                                        @php($data = $dbs ? $dbs : '')
                                        <?php
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                    ...
                                                    @if ($lang == 'en')
                                                        <label
                                                            ...
                                                            <input type="checkbox" name="order_handover_message_status"
                                                                ...
                                                                value="1" id="order_handover_message_status"
                                                                {{ $data ? ($data['status'] == 1 ? 'checked' : '') : '' }}>
                                                            <span class="toggle-switch-label">
                                                                <span class="toggle-switch-indicator"></span>
                                                            </span>
                                                ...
                                                <textarea name="order_handover_message[]" class="form-control order_handover_message"
                                                    oninvalid="document.getElementById('en-link').click()"
                                    ...
                                    <?php
                                    $ofdm = \App\Models\NotificationMessage::with('translations')
                                        ->where('module_type', $mod_type)
                                        ->where('key', 'out_for_delivery_message')
                                        ->first(); ?>
                                    @php($data = $ofdm ? $ofdm : '')
                                    <?php
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="out_for_delivery_message[]" class="form-control out_for_delivery_message"
                                                oninvalid="document.getElementById('en-link').click()"
                                    ...
                                    <?php
                                    $odm = \App\Models\NotificationMessage::with('translations')
                                        ->where('module_type', $mod_type)
                                        ->where('key', 'order_delivered_message')
                                        ->first(); ?>
                                    @php($data = $odm ? $odm : '')
                                    <?php
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="delivered_message[]" class="form-control delivered_message"
                                                oninvalid="document.getElementById('en-link').click()"
                                                @if ($lang == 'en') {{ $data ? ($data['status'] == 1 ? 'required' : '') : '' }} @endif>{!! isset($translate_6) && isset($translate_6[$lang])
                                                    ? $translate_6[$lang]['message']
                                                    : ($data
                                                        ? $data['message']
                                                        : '') !!}</textarea>
                                        </div>
                                    ...
                                    <?php
                                    $dba = \App\Models\NotificationMessage::with('translations')
                                        ->where('module_type', $mod_type)
                                        ->where('key', 'delivery_boy_assign_message')
                                        ->first(); ?>
                                    @php($data = $dba ? $dba : '')
                                    <?php
                                        ...
                                        <div class="form-group">
                                            <div class="d-flex flex-wrap justify-content-between mb-2">
                                                <span class="d-block text--semititle">
                                                    ...
                                                    {{ translate('messages.assign') }} {{ translate('messages.message') }}
                                                </span>
                                                @if ($lang == 'en')
                                                    <label
                                                        class="switch--custom-label toggle-switch d-flex align-items-center mb-0"
                                                        ...
                                                        <input type="checkbox" name="delivery_boy_assign_status"
                                                            ...
                                                            value="1" id="delivery_boy_assign"
                                                            {{ $data ? ($data['status'] == 1 ? 'checked' : '') : '' }}>
                                                        <span class="toggle-switch-label">
                                                            <span class="toggle-switch-indicator"></span>
                                                        </span>
                                            ...
                                            <textarea name="delivery_boy_assign_message[]" class="form-control delivery_boy_assign_message"
                                                oninvalid="document.getElementById('en-link').click()"
                                                @if ($lang == 'en') {{ $data ? ($data['status'] == 1 ? 'required' : '') : '' }} @endif>{!! isset($translate_7) && isset($translate_7[$lang])
                                                    ? $translate_7[$lang]['message']
                                                    : ($data
                                                        ? $data['message']
                                                        : '') !!}</textarea>
                                        </div>
                                    ...
                                    <?php
                                    $dbc = \App\Models\NotificationMessage::with('translations')
                                        ->where('module_type', $mod_type)
                                        ->where('key', 'delivery_boy_delivered_message')
                                        ->first(); ?>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                                ...
                                                @if ($lang == 'en')
                                                    <label
                                                        ...
                                                        <input type="checkbox" name="delivery_boy_delivered_status"
                                                            ...
                                                            value="1" id="delivery_boy_delivered"
                                                            {{ $data ? ($data['status'] == 1 ? 'checked' : '') : '' }}>
                                                        <span class="toggle-switch-label">
                                                            <span class="toggle-switch-indicator"></span>
                                                        </span>
                                            ...
                                            <textarea name="delivery_boy_delivered_message[]" class="form-control delivery_boy_delivered_message"
                                                oninvalid="document.getElementById('en-link').click()"
                                                @if ($lang == 'en') {{ $data ? ($data['status'] == 1 ? 'required' : '') : '' }} @endif>{!! isset($translate_8) && isset($translate_8[$lang])
                                                    ? $translate_8[$lang]['message']
                                                    : ($data
                                                        ? $data['message']
                                                        : '') !!}</textarea>
                                        </div>
                                    ...
                                    $ocm = \App\Models\NotificationMessage::with('translations')
                                        ->where('module_type', $mod_type)
                                        ->where('key', 'order_cancled_message')
                                        ->first(); ?>
                                    @php($data = $ocm ? $ocm : '')
                                    <?php
                                    if (isset($ocm->translations) && count($ocm->translations)) {
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                                ...
                                                @if ($lang == 'en')
                                                    <label
                                                        ...
                                                        <input type="checkbox" name="order_cancled_message_status"
                                                            ...
                                                            value="1" id="order_cancled_message"
                                                            {{ $data ? ($data['status'] == 1 ? 'checked' : '') : '' }}>
                                                        <span class="toggle-switch-label">
                                                            <span class="toggle-switch-indicator"></span>
                                                        </span>
                                            ...
                                            <textarea name="order_cancled_message[]" class="form-control order_cancled_message"
                                                oninvalid="document.getElementById('en-link').click()"
                                                @if ($lang == 'en') {{ $data ? ($data['status'] == 1 ? 'required' : '') : '' }} @endif>{!! isset($translate_9) && isset($translate_9[$lang])
                                                    ? $translate_9[$lang]['message']
                                                    : ($data
                                                        ? $data['message']
                                                        : '') !!}</textarea>
                                        </div>
                                    ...
                                    @if ($mod_type != 'parcel')
                                        <?php
                                        $orm = \App\Models\NotificationMessage::with('translations')
                                            ->where('module_type', $mod_type)
                                            ->where('key', 'order_refunded_message')
                                            ->first(); ?>
                                        @php($data = $orm ? $orm : '')
                                        <?php
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                    ...
                                                    @if ($lang == 'en')
                                                        <label
                                                            ...
                                                            <input type="checkbox" name="order_refunded_message_status"
                                                                ...
                                                                value="1" id="order_refunded_message"
                                                                {{ $data ? ($data['status'] == 1 ? 'checked' : '') : '' }}>
                                                            <span class="toggle-switch-label">
                                                                <span class="toggle-switch-indicator"></span>
                                                            </span>
                                                ...
                                                <textarea name="order_refunded_message[]" class="form-control order_refunded_message"
                                                    oninvalid="document.getElementById('en-link').click()"
                                                    @if ($lang == 'en') {{ $data ? ($data['status'] == 1 ? 'required' : '') : '' }} @endif>{!! isset($translate_10) && isset($translate_10[$lang])
                                                        ? $translate_10[$lang]['message']
                                                        : ($data
                                                            ? $data['message']
                                                            : '') !!}</textarea>
                                            </div>
                                        ...
                                        <?php
                                        $rrcm = \App\Models\NotificationMessage::with('translations')
                                            ->where('module_type', $mod_type)
                                            ->where('key', 'refund_request_canceled')
                                            ->first(); ?>
                                        @php($data = $rrcm ? $rrcm : '')
                                        <?php
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                    ...
                                                    @if ($lang == 'en')
                                                        <label
                                                            ...
                                                            <input type="checkbox" name="refund_request_canceled_status"
                                                                ...
                                                                value="1" id="refund_request_canceled"
                                                                {{ $data ? ($data['status'] == 1 ? 'checked' : '') : '' }}>
                                                            <span class="toggle-switch-label">
                                                                <span class="toggle-switch-indicator"></span>
                                                            </span>
                                                ...
                                                <textarea name="refund_request_canceled[]" class="form-control refund_request_canceled"
                                                    oninvalid="document.getElementById('en-link').click()"
                                                    @if ($lang == 'en') {{ $data ? ($data['status'] == 1 ? 'required' : '') : '' }} @endif>{!! isset($translate_11) && isset($translate_11[$lang])
                                                        ? $translate_11[$lang]['message']
                                                        : ($data
                                                            ? $data['message']
                                                            : '') !!}</textarea>
                                            </div>
