    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-header-title">
                ...
                <span>
                    {{ translate('messages.reCaptcha') }} {{ translate('messages.credentials') }}
                        ...
                        <div class="mt-4">
                            ...
                            <form
                                ...
                                <div class="d-flex flex-wrap mb-4">
                                    ...
                                    <label class="form-check form--check">
                                        ...
                                        <span
                                            class="form-check-label text--title pl-2">{{ translate('messages.inactive') }}</span>
                                    </label>
                                </div>
                            ...
                            <div class="modal fade" id="recaptcha-modal" data-backdrop="static" data-keyboard="false"
                                ...
                                <div class="modal-dialog">
                                    <div
                                        class="modal-content {{ Session::get('direction') === 'rtl' ? 'text-right' : 'text-left' }}">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="staticBackdropLabel">
                                                {{ translate('messages.reCaptcha credential Set up Instructions') }}</h5>
                                        ...
                                        <div class="modal-body">
                                            <ol>
                                                ...
                                                <li>{{ translate('messages.Add a ') }}
                                                    <b>{{ translate('messages.label') }}</b>
                                                    {{ translate('messages.(Ex: Test Label)') }}
                                                </li>
                                                <li>
                                                ...
                                                <li>{{ translate('messages.Copy') }} <b>Site
                                                        ...
                                                        Key</b>,
                                                    {{ translate('messages.paste in the input filed below and') }}
                                                    <b>Save</b>.
                                                </li>
                                            </ol>
                                        </div>
