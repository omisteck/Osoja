            ...
            <div class="card-body">
                <form class="text-left" action="javascript:">
                    ...
                    <div class="btn--container justify-content-end">
                        ...
                        <a href="javascript:" id="update"
                            class="initial-hidden btn btn--primary">{{ translate('messages.update') }}</a>
                    </div>
                </form>
            </div>
        </div>
                ...
                success: function(data) {
                    if (data.length != 0) {
                        ...
                        for (var count = 0; count < data.length; count++) {
                            ...
                            html +=
                                '<td><a type="button" class="btn btn--primary btn-outline-primary edit action-btn" id="' +
                                data[
