                        ...
                        <div class="col-sm-12 col-xl-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form
                                        action="{{ route('admin.business-settings.landing-page-settings', 'module-section') }}"
                                            ...
                                            <div class="col-sm-6 col-xl-6">
                                                <div class="form-group">
                                                    <label class="input-label">{{ translate('messages.image') }}<small
                                                            class="text-danger"> ( {{ translate('messages.size') }}: 140 X
                                                            140 px )</small></label>
                                                    <div class="custom-file">
                                                        <input type="file" name="image"
                                                            id="customFileEg-{{ $key }}" class="custom-file-input"
                                                            accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                                        <label class="custom-file-label"
                                                            for="customFileEg-{{ $key }}">{{ translate('messages.choose') }}
                                                            {{ translate('messages.file') }}</label>
                                                    </div>

                                                    <center id="image-viewer-section-{{ $key }}" class="pt-4">
                                                        <img class="img--120" id="viewer-{{ $key }}"
                                                            src="{{ asset('assets/landing') }}/image/{{ isset($module_value['img']) ? $module_value['img'] : 'double_screen_image.png' }}"
                                        ...
                                        <div class="btn--container justify-content-end">
                                            <button type="reset" id="reset-button-{{ $key }}"
