                    ...
                    <div class="row gy-3">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label class="input-label"
                                    for="feature_title">{{ translate('messages.feature_title') }}</label>
                            ...
                            <div class="form-group mb-0">
                                ...
                                <textarea placeholder="{{ translate('Feature description') }}" name="feature_description" class="form-control"
                        ...
                        <div class="col-lg-6">
                            <div class="form-group h-100 d-flex flex-column mb-0">
                                <label
                                    class="input-label text-center d-block mt-auto mb-lg-0">{{ translate('messages.feature_img') }}<small
                                        class="text-danger">* (
