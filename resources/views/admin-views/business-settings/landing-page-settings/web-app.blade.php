            ...
            <div class="card-body landing-page-images">
                ...
                <div class="row gy-4">
                    <div class="col-sm-6 col-xl-4">
                        <form action="{{ route('admin.business-settings.landing-page-settings', 'web-app') }}"
                            method="POST" enctype="multipart/form-data">
                            @csrf
                            <label class="form-group d-block">
                                <span class="input-label text-center">{{ translate('messages.top_content_image') }}<small
                                        class="text-danger"> ( {{ translate('messages.size') }}: 772 X 899 px
                                        )</small></span>
                            ...
                            <div class="form-group mb-0">
                                <div class="landing--page-btns btn--container justify-content-center">
                                    <label class="btn btn--reset"
                                        for="customFileEg1">{{ translate('change image') }}</label>
                                    <button type="submit"
                    ...
                    <div class="col-sm-6 col-xl-4">
                        <form action="{{ route('admin.business-settings.landing-page-settings', 'web-app') }}"
                            ...
                            <label class="form-group d-block">
                                <span
                                    class="input-label text-center">{{ translate('messages.mobile_app_section_image') }}<small
                                ...
                                <input type="file" name="mobile_app_section_image" id="customFileEg4"
                            ...
                            <div class="form-group mb-0">
                                <div class="landing--page-btns btn--container justify-content-center">
                                    <label class="btn btn--reset"
                                        for="customFileEg4">{{ translate('change image') }}</label>
                                    <button type="submit"
                                        class="btn btn--primary">{{ translate('messages.upload') }}</button>
                                </div>
                            </div>
