        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('admin.business-settings.landing-page-settings', 'text') }}" method="POST">
                    ...
                    <div class="form-group">
                        <label
                            for="mobile_app_section_heading">{{ translate('messages.mobile_app_section_heading') }}</label>
                        <input type="text" id="mobile_app_section_heading" name="mobile_app_section_heading"
                            class="form-control"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="mobile_app_section_text" name="mobile_app_section_text"
                            class="form-control"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="module_section_sub_title" name="module_section_sub_title"
                            class="form-control"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="refer_section_sub_title" name="refer_section_sub_title"
                            class="form-control"
                            value="{{ isset($landing_page_text['refer_section_sub_title']) ? $landing_page_text['refer_section_sub_title'] : '' }}">
                    </div>
                    <div class="form-group">
                        <label
                            for="refer_section_description">{{ translate('messages.refer_section_description') }}</label>
                        <textarea id="refer_section_description" name="refer_section_description" class="form-control" cols="30"
                            rows="5">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="joinus_section_sub_title" name="joinus_section_sub_title"
                            class="form-control"
                            value="{{ isset($landing_page_text['joinus_section_sub_title']) ? $landing_page_text['joinus_section_sub_title'] : '' }}">
                    </div>
                    <div class="form-group">
                        <label
                            for="download_app_section_title">{{ translate('messages.download_app_section_title') }}</label>
                        <input type="text" id="download_app_section_title" name="download_app_section_title"
                            class="form-control"
                            value="{{ isset($landing_page_text['download_app_section_title']) ? $landing_page_text['download_app_section_title'] : '' }}">
                    </div>
                    <div class="form-group">
                        <label
                            for="download_app_section_sub_title">{{ translate('messages.download_app_section_sub_title') }}</label>
                        <input type="text" id="download_app_section_sub_title" name="download_app_section_sub_title"
                            class="form-control"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="feature_section_title" name="feature_section_title"
                            class="form-control"
                            value="{{ isset($landing_page_text['feature_section_title']) ? $landing_page_text['feature_section_title'] : '' }}">
                    </div>
                    <div class="form-group">
                        <label
                            for="feature_section_description">{{ translate('messages.feature_section_description') }}</label>
                        <textarea id="feature_section_description" name="feature_section_description" class="form-control" cols="30"
                            rows="5">
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" id="newsletter_title" name="newsletter_title" class="form-control">{{ isset($landing_page_text['newsletter_title']) ? $landing_page_text['newsletter_title'] : '' }}</textarea>
                    </div>
                    <div class="form-group">
                        <label for="newsletter_sub_title">{{ translate('messages.newsletter_sub_title') }}</label>
                        <textarea type="text" id="newsletter_sub_title" name="newsletter_sub_title" class="form-control">{{ isset($landing_page_text['newsletter_sub_title']) ? $landing_page_text['newsletter_sub_title'] : '' }}</textarea>
                    </div>
                    <div class="form-group">
                        <label for="contact_us_title">{{ translate('messages.contact_us_title') }}</label>
                        <textarea type="text" id="contact_us_title" name="contact_us_title" class="form-control">{{ isset($landing_page_text['contact_us_title']) ? $landing_page_text['contact_us_title'] : '' }}</textarea>
                    </div>
                    <div class="form-group">
                        <label for="contact_us_sub_title">{{ translate('messages.contact_us_sub_title') }}</label>
                        <textarea type="text" id="contact_us_sub_title" name="contact_us_sub_title" class="form-control">{{ isset($landing_page_text['contact_us_sub_title']) ? $landing_page_text['contact_us_sub_title'] : '' }}</textarea>
                    </div>
                    <div class="form-group">
                        <label for="footer_article">{{ translate('messages.footer_article') }}</label>
                        <textarea type="text" id="footer_article" name="footer_article" class="form-control">{{ isset($landing_page_text['footer_article']) ? $landing_page_text['footer_article'] : '' }}</textarea>
                    </div>
