            ...
            <div class="card-body landing-page-images">
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <form action="{{ route('admin.business-settings.landing-page-settings', 'joinas') }}" method="POST"
                            enctype="multipart/form-data">
                            @csrf
                            <label class="form-group d-block">
                                <span
                                    class="input-label text-center">{{ translate('messages.seller_banner_background') }}<small
                                        class="text-danger"> ( {{ translate('messages.size') }}: 1600 X 400 px
                                        )</small></span>
                                <center id="image-viewer-section5" class="pt-3 img--200 mx-auto">
                                    <img class="border rounded w-100" id="viewer5"
                                        src="{{ asset('assets/landing') }}/image/{{ isset($landing_page_images['seller_banner_bg']) ? $landing_page_images['seller_banner_bg'] : 'double_screen_image.png' }}"
                                        onerror="this.src='{{ asset('assets/admin/img/400x400/img2.jpg') }}'"
                                        alt="" />
                                </center>
                                <input type="file" name="seller_banner_bg" id="customFileEg5" class="custom-file-input"
                            ...
                            <div class="form-group mb-0">
                                <div class="landing--page-btns btn--container justify-content-center">
                                    <label class="btn btn--reset"
                                        for="customFileEg5">{{ translate('change image') }}</label>
                                    <button type="submit"
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <form action="{{ route('admin.business-settings.landing-page-settings', 'joinas') }}"
                            method="POST" enctype="multipart/form-data">
                            @csrf
                            <label class="form-group d-block">
                                <span
                                    class="input-label text-center">{{ translate('messages.deliveryman_banner_background') }}<small
                                        class="text-danger"> ( {{ translate('messages.size') }}: 1600 X 400 px
                                        )</small></span>
                                <center id="image-viewer-section6" class="pt-3 img--200 mx-auto">
                                    <img class="border rounded w-100" id="viewer6"
                                        src="{{ asset('assets/landing') }}/image/{{ isset($landing_page_images['deliveryman_banner_bg']) ? $landing_page_images['deliveryman_banner_bg'] : 'double_screen_image.png' }}"
                                        onerror="this.src='{{ asset('assets/admin/img/400x400/img2.jpg') }}'"
                                        alt="" />
                                </center>
                                <input type="file" name="deliveryman_banner_bg" id="customFileEg6"
