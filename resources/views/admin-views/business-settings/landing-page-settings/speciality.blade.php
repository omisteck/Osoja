...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="card mb-3">
            <div class="card-body">
                <form action="{{ route('admin.business-settings.landing-page-settings', 'speciality') }}" method="POST"
                    ...
                    <div class="form-group">
                        <label class="input-label"
                            for="speciality_title">{{ translate('messages.speciality_title') }}</label>
                        <input type="text" id="speciality_title" name="speciality_title" class="form-control"
                            placeholder="Speciality title">
                    </div>
                    <div class="form-group">
                        <label class="input-label">{{ translate('messages.speciality_img') }}<small class="text-danger">* (
                                {{ translate('messages.size') }}: 60 X 60 px )</small></label>
                                ...
                                @foreach ($speciality as $key => $sp)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="media align-items-center">
                                                <img class="avatar avatar-lg mr-3"
                                                    src="{{ asset('assets/landing/image') }}/{{ $sp['img'] }}"
                                        ...
                                        <td>
                                            ...
                                            <form
                                                action="{{ route('admin.business-settings.landing-page-settings-delete', ['tab' => 'speciality', 'key' => $key]) }}"
