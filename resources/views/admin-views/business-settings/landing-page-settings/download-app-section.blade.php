            ...
            <div class="card-body landing-page-images">
                ...
                <div class="row gy-4">
                    <div class="col-sm-12 col-xl-12">
                        <form action="{{ route('admin.business-settings.landing-page-settings', 'download-section') }}"
                            id="tnc-form" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-xl-6">
                                    <div class="form-group">
                                        <label class="input-label">{{ translate('messages.image') }}<small
                                                class="text-danger"> * ( {{ translate('messages.size') }}: 514 X 378 px
                                                )</small></label>
                                        <div class="custom-file">
                                            <input type="file" name="image" id="customFileEg" class="custom-file-input"
                                                accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                            <label class="custom-file-label"
                                                for="customFileEg">{{ translate('messages.choose') }}
                                                {{ translate('messages.file') }}</label>
                                        </div>

                                        <center id="image-viewer-section" class="pt-4">
                                            <img class="img--200 border" id="viewer"
                                                src="{{ asset('assets/landing') }}/image/{{ isset($download_app_section['img']) ? $download_app_section['img'] : 'double_screen_image.png' }}"
                    ...
                    <div class="col-sm-12 col-xl-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form
                                    action="{{ route('admin.business-settings.landing-page-settings', 'counter-section') }}"
                                    id="tnc-form" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-sm-4 col-xl-4">
                                            <div class="form-group">
                                                <label
                                                    class="input-label">{{ translate('messages.app_download_count_numbers') }}</label>
                                                <input class="form-control"
                                                    value="{{ $counter['app_download_count_numbers'] ?? '' }}"
                                                    name="app_download_count_numbers">
                                            </div>
                                        </div>
                                        <div class="col-sm-4 col-xl-4">
                                            <div class="form-group">
                                                <label
                                                    class="input-label">{{ translate('messages.seller_count_numbers') }}</label>
                                                <input class="form-control" name="seller_count_numbers"
                                                    value="{{ $counter['deliveryman_count_numbers'] ?? '' }}">
                                            </div>
                                        </div>
                                        <div class="col-sm-4 col-xl-4">
                                            <div class="form-group">
                                                <label
                                                    class="input-label">{{ translate('messages.deliveryman_count_numbers') }}</label>
                                                <input class="form-control"
                                                    value="{{ $counter['deliveryman_count_numbers'] ?? '' }}"
                                                    name="deliveryman_count_numbers">
                                            </div>
                                        </div>
                                    </div>
