        ...
        <div class="page-header">
            <div class="d-flex flex-wrap justify-content-between align-items-center">
                <h1 class="page-header-title">
                    ...
                    <span>
                        {{ translate('messages.sms') }} {{ translate('messages.gateway') }}
                        ...
                        <form class="sms-module-form"
                            ...
                            <div>
                                <h5 class="d-flex flex-wrap justify-content-between align-items-center text-uppercase">
                                    ...
                                    <div class="pl-2">
                                        <img src="{{ asset('assets/admin/img/twilio.png') }}" alt="public" width="38px"
                                            height="38px">
                                    </div>
                                </h5>
                                <span
                                    class="badge badge-soft-info mb-3">{{ translate('NB : #OTP# will be replace with otp') }}</span>
                                <div class="d-flex flex-wrap mb-4">
                                    <label class="form-check form--check mr-2 mr-md-4">
                                        <input class="form-check-input" type="radio" name="status" value="1"
                                            {{ isset($config) && $config['status'] == 1 ? 'checked' : '' }}>
                                        <span
                                            class="form-check-label text--title pl-2">{{ translate('messages.active') }}</span>
                                    </label>
                                    <label class="form-check form--check">
                                        <input class="form-check-input" type="radio" name="status" value="0"
                                            {{ isset($config) && $config['status'] == 0 ? 'checked' : '' }}>
                                        <span
                                            class="form-check-label text--title pl-2">{{ translate('messages.inactive') }}
                                        </span>
                                    </label>
                                </div>
                                <div class="form-group">
                                    <label class="text-capitalize form-label">{{ translate('messages.sid') }}</label>
                                    <input type="text" class="form-control" name="sid"
                                        value="{{ env('APP_MODE') != 'demo' ? $config['sid'] ?? '' : '' }}">
                                </div>
                                <div class="form-group">
                                    <label
                                        class="text-capitalize form-label">{{ translate('messages.messaging_service_id') }}</label>
                                ...
                                <div class="form-group">
                                    <label
                                        class="text-capitalize form-label">{{ translate('messages.otp_template') }}</label>
            ...
            <div class="col-md-6">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <form class="sms-module-form"
                            action="{{ env('APP_MODE') != 'demo' ? route('admin.business-settings.sms-module-update', ['nexmo_sms']) : 'javascript:' }}"
                            method="post">
                            @csrf
                            <div>
                                <h5 class="d-flex flex-wrap justify-content-between align-items-center text-uppercase">
                                    ...
                                    <div class="pl-2">
                                        <img src="{{ asset('assets/admin/img/nexmo.png') }}" alt="public" width="38px"
                                            height="38px">
                                    </div>
                                </h5>
                                <span
                                    class="badge badge-soft-info mb-3">{{ translate('messages.NB : #OTP# will be replace with otp') }}</span>
                                <div class="d-flex flex-wrap mb-4">
                                    <label class="form-check form--check mr-2 mr-md-4">
                                        <input class="form-check-input" type="radio" name="status" value="1"
                                            {{ isset($config) && $config['status'] == 1 ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    <label class="form-label text-capitalize">{{ translate('messages.api_key') }}</label>
                                    <input type="text" class="form-control" name="api_key"
                                        value="{{ env('APP_MODE') != 'demo' ? $config['api_key'] ?? '' : '' }}">
                                </div>
                                <div class="form-group">
                                    <label
                                        class="form-label text-capitalize">{{ translate('messages.api_secret') }}</label>
                                ...
                                <div class="form-group">
                                    <label
                                        class="form-label text-capitalize">{{ translate('messages.otp_template') }}</label>
                                    <input type="text" class="form-control" name="otp_template"
                                        value="{{ env('APP_MODE') != 'demo' ? $config['otp_template'] ?? '' : '' }}">
                                </div>
                            </div>
                        ...
                        <form class="sms-module-form"
                            ...
                            <div>
                                <h5 class="d-flex flex-wrap justify-content-between align-items-center text-uppercase">
                                    ...
                                    <div class="pl-2">
                                        <img src="{{ asset('assets/admin/img/two_factor.png') }}" alt="public"
                                            width="38px" height="38px">
                                    </div>
                                </h5>
                                <div>
                                    <span
                                        class="badge badge-soft-info mb-1">{{ translate('EX of SMS provider`s template : your OTP is XXXX here, please check.') }}</span>
                                </div>
                                <div>
                                    <span
                                        class="badge badge-soft-info mb-3">{{ translate('messages.NB : #OTP# will be replace with otp') }}</span>
                        ...
                        <form class="sms-module-form"
                            ...
                            <div>
                                <h5 class="d-flex flex-wrap justify-content-between align-items-center text-uppercase">
                                    ...
                                    <div class="pl-2">
                                        <img src="{{ asset('assets/admin/img/msg91.png') }}" alt="public"
                                            width="38px" height="38px">
                                    </div>
                                </h5>
                                <span
                                    class="badge badge-soft-info mb-3">{{ translate('NB : Keep an OTP variable in your SMS providers OTP Template.') }}</span>
                                ...
                                <div class="form-group">
                                    <label
                                        class="form-label text-capitalize">{{ translate('messages.template_id') }}</label>
                                    <input type="text" class="form-control" name="template_id"
                                        value="{{ env('APP_MODE') != 'demo' ? $config['template_id'] ?? '' : '' }}">
                                </div>
                                <div class="form-group">
                                    <label class="form-label text-capitalize">{{ translate('messages.authkey') }}</label>
