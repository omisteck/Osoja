                                ...
                                <form class="" action="javascript:">
                                    <div class="row gx-3 gy-1">
                                        ...
                                        <div class="col-md-4 col-sm-5">
                                            <button type="button"
                                                onclick="{{ env('APP_MODE') == 'demo' ? 'call_demo()' : 'send_mail()' }}"
                                                class="btn btn--primary h--45px btn-block">
        ...
        <div class="card">
            <form class="card-body"
                ...
                <div class="form-group mb-3 text-center d-flex flex-wrap align-items-center">
                    <label
                        class="control-label h3 mb-0 text-capitalize mr-3">{{ translate('mail_configuration_status') }}</label>
                    <!-- Static Switch Box -->
                    <div class="custom--switch">
                        <input type="checkbox" name="status" value="1" id="switch6" switch="primary"
                            {{ isset($data['status']) && $data['status'] == 1 ? 'checked' : '' }}>
                        <label for="switch6" data-on-label="{{ translate('messages.on') }}"
                            data-off-label="{{ translate('messages.off') }}"></label>
                    </div>
                    <!-- Static Switch Box -->
                </div>
                ...
                <div class="row g-3">
                    <div class="col-sm-6">
                        <div class="form-group mb-0">
                            ...
                            <input type="text" placeholder="{{ translate('messages.Ex:') }} Alex" class="form-control"
                    ...
                    <div class="col-sm-6">
                        <div class="form-group mb-0">
                            ...
                            <input type="text" class="form-control" name="host"
                                placeholder="{{ translate('messages.Ex_:_mail.6am.one') }}"
                    ...
                    <div class="col-sm-6">
                        <div class="form-group mb-0">
                            ...
                            <input type="text" placeholder="{{ translate('messages.Ex:') }} ex@yahoo.com"
                    ...
                    <div class="col-sm-6">
                        <div class="form-group mb-0">
                            ...
                            <input type="text" placeholder="{{ translate('messages.Ex:') }} tls" class="form-control"
                                name="encryption"
