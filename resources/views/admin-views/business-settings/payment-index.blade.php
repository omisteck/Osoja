        ...
        <div class="page-header">
            <div class="d-flex flex-wrap justify-content-between align-items-center">
                <h1 class="page-header-title">
                    ...
                    <span>
                        {{ translate('messages.payment') }} {{ translate('messages.gateway') }}
                            ...
                            <div class="d-flex flex-wrap p-0">
                                ...
                                <label class="form-check form--check">
                                    <input class="form-check-input" type="radio" name="status" value="0"
                                        {{ $config ? ($config['status'] == 0 ? 'checked' : '') : '' }}>
                ...
                <div class="card h-100">
                    ...
                    <div class="card-body pt-3">
                        ...
                        <form action="{{ route('admin.business-settings.payment-method-update', ['digital_payment']) }}"
                            method="post">
                            @csrf
                            <h5 class="text-capitalize mb-3">{{ translate('messages.digital') }}
                                {{ translate('messages.payment') }}</h5>
                            <div class="d-flex flex-wrap p-0">
                                <label class="form-check form--check mr-2 mr-md-4">
                                    <input class="form-check-input digital_payment" type="radio" name="status"
                                        value="1"
                                ...
                                <label class="form-check form--check">
                                    <input class="form-check-input digital_payment" type="radio" name="status"
                                        value="0"
                                        {{ $digital_payment ? ($digital_payment['status'] == 0 ? 'checked' : '') : '' }}>
                                    <span class="form-check-label">{{ translate('messages.inactive') }}</span>
                                </label>
                            </div>
                            <div class="text-right mt-4 pt-2 mr-2">
                    ...
                    <div class="card-body p-30px">
                        <form
                            ...
                            <div class="form-group mb-4">
                                <input class="form-control" type="text" name="store_id" placeholder="Store ID"
                                    value="{{ env('APP_MODE') != 'demo' ? ($config ? $config['store_id'] : '') : '' }}">
                            </div>
                            <div class="form-group mb-4">
                                <input class="form-control" type="text" name="store_password"
                ...
                <div class="card">
                    <div class="card-body p-30px">
                        ...
                        <form
                            ...
                            <div class="form-group mb-4">
                                <input class="form-control" type="text" placeholder="Paypal Client Id"
                                    name="paypal_client_id"
                                    value="{{ env('APP_MODE') != 'demo' ? ($config ? $config['paypal_client_id'] : '') : '' }}">
                            </div>
                            <div class="form-group mb-4">
                                <input class="form-control" type="text" placeholder="Paypal Secret"
                                    name="paypal_secret"
                ...
                <div class="card">
                    <div class="card-body p-30px">
                        ...
                        <form
                            ...
                            <div class="form-group mb-4">
                                <input class="form-control" type="text" placeholder="Razor Secret"
                                    name="razor_secret"
                ...
                <div class="card">
                    <div class="card-body p-30px">
                        ...
                        <form
                            ...
                            <div class="form-group mb-4">
                                <input class="form-control" type="text" placeholder="Publish Key"
                                    name="published_key"
                    ...
                    <div class="card-body p-30px">
                        ...
                        <form
                            ...
                            @if (isset($config))
                                ...
                                <span
                                    class="badge badge-soft-danger">{{ translate('messages.paystack_callback_warning') }}</span>
                                <div class="payment--gateway-img">
                                ...
                                <div class="form-group mb-4">
                                    <input class="form-control" type="text" placeholder="Payment Url"
                                        name="paymentUrl" value="{{ env('APP_MODE') != 'demo' ? $config['paymentUrl'] : '' }}">
                                </div>
                                <div class="form-group mb-4">
                                    <input class="form-control" type="text" placeholder="Merchant Email"
                                        name="merchantEmail"
                                        value="{{ env('APP_MODE') != 'demo' ? $config['merchantEmail'] : '' }}">
                                </div>
                                <div class="btn--container justify-content-end">
                                    <button type="button"
                                        class="btn h--37px btn-success"onclick="copy_text('{{ url('/') }}/paystack-callback')">{{ translate('messages.copy_callback') }}</button>
                                    <button type="{{ env('APP_MODE') != 'demo' ? 'submit' : 'button' }}"
                                        onclick="{{ env('APP_MODE') != 'demo' ? '' : 'call_demo()' }}"
                                        class="btn h--37px btn--primary">{{ translate('messages.save') }}</button>
                                </div>
                            ...
                            @if (isset($config))
                                ...
                                <div class="form-group mb-4">
                                    <input class="form-control" type="text" placeholder="Secret Key"
                                        name="secret_key" value="{{ env('APP_MODE') != 'demo' ? $config['secret_key'] : '' }}">
                                </div>
                                <div class="form-group mb-4">
                                    <input class="form-control" type="text" placeholder="Merchant Key"
                                        name="merchant_id"
                    ...
                    <div class="card-body p-30px">
                        ...
                        <form
                            ...
                            @if (isset($config))
                                ...
                                <div class="form-group mb-4">
                                    <input class="form-control" type="text" placeholder="Public Key"
                                        name="public_key"
                    ...
                    <div class="card-body p-30px">
                        ...
                        <form
                            ...
                            @if (isset($config))
                                ...
                                <div class="payment--gateway-img">
                                    <img src="{{ asset('/assets/admin/img/payment/mercador-pago.png') }}"
                                        alt="public">
                                </div>
                                <div class="form-group mb-4">
                                    <input class="form-control" type="text" placeholder="Public Key"
                    ...
                    <div class="card-body p-30px">
                        ...
                        <form
                            ...
                            @if (isset($config))
                                ...
                                <div class="form-group mb-4">
                                    <label
                                        class="{{ Session::get('direction') === 'rtl' ? 'pr-3' : 'pl-3' }}">{{ translate('messages.callback') }}</label>
                                    <span class="btn btn-secondary btn-sm m-2"
                                        onclick="copyToClipboard('#id_paymob_accept')"><i class="tio-copy"></i>
                                        {{ translate('messages.copy_callback') }}</span>

                                    <p class="form-control" id="id_paymob_accept">{{ url('/') }}/paymob-callback
                                    </p>
                                </div>
                                <div class="form-group mb-4">
                                    <input class="form-control" type="text" placeholder="Api Key" name="api_key"
                                ...
                                <div class="form-group mb-4">
                                    <input class="form-control" type="text" placeholder="Integration Id"
                                        name="integration_id"
                    ...
                    <div class="card-body p-30px">
                        ...
                        <form
                            ...
                            @if (isset($config))
                                ...
                                <div class="form-group mb-4">
                                    <input class="form-control" type="text" placeholder="Api Secret"
                                        name="api_secret"
                    ...
                    <div class="card-body p-30px">
                        ...
                        <form
                            ...
                            @if (isset($config))
                                ...
                                <div class="form-group mb-4">
                                    <input class="form-control" type="text" placeholder="Profile Id"
                                        name="profile_id"
                                        value="{{ env('APP_MODE') != 'demo' ? $config['profile_id'] : '' }}">
                                </div>
                                <div class="form-group mb-4">
                                    <input class="form-control" type="text" placeholder="Server Key"
                                        name="server_key"
                                        value="{{ env('APP_MODE') != 'demo' ? $config['server_key'] : '' }}">
                                </div>
                                <div class="form-group mb-4">
                                    <input class="form-control" type="text" placeholder="Base Url by Region"
                                        name="base_url" value="{{ env('APP_MODE') != 'demo' ? $config['base_url'] : '' }}">
                                </div>
                                <div class="btn--container justify-content-end">
                                    <button type="{{ env('APP_MODE') != 'demo' ? 'submit' : 'button' }}"
                                        onclick="{{ env('APP_MODE') != 'demo' ? '' : 'call_demo()' }}"
                    ...
                    <div class="card-body p-30px">
                        ...
                        <form
                            ...
                            @if (isset($config))
                                ...
                                <div class="form-group mb-4">
                                    <input class="form-control" type="text" placeholder="Paytm Merchant Key"
                                        name="paytm_merchant_key"
                                        value="{{ env('APP_MODE') != 'demo' ? $config['paytm_merchant_key'] : '' }}">
                                </div>
                                <div class="form-group mb-4">
                                    <input class="form-control" type="text" placeholder="Paytm Merchant Mid"
                                        name="paytm_merchant_mid"
                                        value="{{ env('APP_MODE') != 'demo' ? $config['paytm_merchant_mid'] : '' }}">
                                </div>
                                <div class="form-group mb-4">
                                    <input class="form-control" type="text" placeholder="Merchant Website"
