                                ...
                                <div class="form-group mb-0">
                                    <label
                                        ...
                                        <span class="pr-2">{{ translate('messages.manage_item_setup') }}<span
                                                ...
                                                data-original-title="{{ translate('By disabling this field, the store can`t manage items, which means the store web panel app won`t get the access for managing items') }}"><img
                                                    src="{{ asset('/assets/admin/img/info-circle.svg') }}"
                                                    alt="{{ translate('messages.show_hide_food_menu') }}"></span></span>
                                        <input type="checkbox" class="toggle-switch-input"
                                            onclick="location.href='{{ route('admin.store.toggle-settings', [$store->id, $store->item_section ? 0 : 1, 'item_section']) }}'"
                                            name="item_section" id="item_section"
                                ...
                                <div class="form-group mb-0">
                                    <label
                                        ...
                                        <span class="pr-2">{{ translate('messages.Show_Reviews_In_Store_Panel') }}<span
                                                class="input-label-secondary" data-toggle="tooltip" data-placement="right"
                                                data-original-title="{{ translate('If this field is active, the store panel & store app can see the customer`s review') }}"><img
                                                    src="{{ asset('/assets/admin/img/info-circle.svg') }}"
                                                    alt="{{ translate('messages.show_hide_food_menu') }}"></span> </span>
                                        <input type="checkbox" class="toggle-switch-input"
                                            onclick="location.href='{{ route('admin.store.toggle-settings', [$store->id, $store->reviews_section ? 0 : 1, 'reviews_section']) }}'"
                                            name="reviews_section" id="reviews_section"
                            ...
                            <div class="col-sm-6 col-lg-4">
                                <div class="form-group mb-0">
                                    <label
                                        ...
                                        for="pos_system">
                                        <span
                                            class="pr-2 text-capitalize">{{ translate('messages.include_POS_in_store_panel') }}<span
                                                class="input-label-secondary" data-toggle="tooltip" data-placement="right"
                                                data-original-title="{{ translate('If this option is turned on, the store panel will get the
                                                                                                                                    Point of Sale (POS) option') }}"><img
                                                    src="{{ asset('/assets/admin/img/info-circle.svg') }}"
                                                    alt="{{ __('messages.pos_system_hint') }}"></span></span>
                                        <input type="checkbox" class="toggle-switch-input"
                                            onclick="location.href='{{ route('admin.store.toggle-settings', [$store->id, $store->pos_system ? 0 : 1, 'pos_system']) }}'"
                                ...
                                <div class="form-group mb-0">
                                    <label
                                        ...
                                        <span class="pr-2">{{ translate('messages.scheduled') }}
                                            {{ translate('messages.order_option') }}<span class="input-label-secondary"
                                                data-toggle="tooltip" data-placement="right"
                                                data-original-title="{{ translate('If this status is turned on, the customer is able to place a scheduled
                                                                                                                                    order for this store') }}"><img
                                                    src="{{ asset('/assets/admin/img/info-circle.svg') }}"
                                                    alt="{{ __('messages.scheduled_order_hint') }}"></span></span>
                                        <input type="checkbox" class="toggle-switch-input"
                                            onclick="location.href='{{ route('admin.store.toggle-settings', [$store->id, $store->schedule_order ? 0 : 1, 'schedule_order']) }}'"
                            ...
                            <div class="col-sm-6 col-lg-4">
                                <div class="form-group mb-0">
                                    <label
                                        ...
                                        <span class="pr-2 text-capitalize">{{ translate('messages.self_delivery') }}<span
                                                class="input-label-secondary" data-toggle="tooltip" data-placement="right"
                                                data-original-title="{{ translate('When this option is enabled, stores need to deliver orders by themselves or
                                                                                                                                    by their own delivery man. Stores will also get an option for adding their own delivery man
                                                                                                                                    from the store panel') }}"><img
                                                    src="{{ asset('/assets/admin/img/info-circle.svg') }}"
                                                    alt="{{ __('messages.self_delivery_hint') }}"></span></span>
                                        <input type="checkbox" class="toggle-switch-input"
                                            onclick="location.href='{{ route('admin.store.toggle-settings', [$store->id, $store->self_delivery_system ? 0 : 1, 'self_delivery_system']) }}'"
                                ...
                                <div class="form-group mb-0">
                                    <label
                                        ...
                                        <span class="pr-2">{{ translate('messages.home_delivery') }}<span
                                                ...
                                                data-original-title="{{ translate('messages.home_delivery_hint') }}"><img
                                                    src="{{ asset('/assets/admin/img/info-circle.svg') }}"
                                                    alt="{{ __('messages.home_delivery_hint') }}"></span></span>
                                        <input type="checkbox" name="delivery" class="toggle-switch-input"
                                            onclick="location.href='{{ route('admin.store.toggle-settings', [$store->id, $store->delivery ? 0 : 1, 'delivery']) }}'"
                                ...
                                <div class="form-group mb-0">
                                    <label
                                        ...
                                        <span class="pr-2 text-capitalize">{{ translate('messages.take_away') }}<span
                                                class="input-label-secondary" data-toggle="tooltip"
                                                data-placement="right"
                                                data-original-title="{{ __('messages.take_away_hint') }}"><img
                                                    src="{{ asset('/assets/admin/img/info-circle.svg') }}"
                                                    alt="{{ __('messages.take_away_hint') }}"></span></span>
                                        <input type="checkbox" class="toggle-switch-input"
                                            onclick="location.href='{{ route('admin.store.toggle-settings', [$store->id, $store->take_away ? 0 : 1, 'take_away']) }}'"
                                            ...
                                            <label
                                                ...
                                                <span
                                                    class="pr-2 text-capitalize">{{ translate('messages.prescription_order') }}<span
                                                        class="input-label-secondary" data-toggle="tooltip"
                                                        data-placement="right"
                                                        data-original-title="{{ __('messages.prescription_order_hint') }}"><img
                                                            src="{{ asset('/assets/admin/img/info-circle.svg') }}"
                                                            alt="{{ __('messages.prescription_order_hint') }}"></span></span>
                                                <input type="checkbox" class="toggle-switch-input"
                                                    onclick="location.href='{{ route('admin.store.toggle-settings', [$store->id, $store->prescription_order ? 0 : 1, 'prescription_order']) }}'"
                                ...
                                <div class="row">
                                    @if ($toggle_veg_non_veg && config('module.' . $store->module->module_type)['veg_non_veg'])
                                        <div class="col-sm-6 col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <div
                                                    class="resturant-type-group border rounded px-3 d-flex flex-wrap min--h-45px">
                                                    <label class="form-check form--check mr-2 mr-md-4">
                                                        <input class="form-check-input" type="radio" name="veg_non_veg"
                                                            value="veg"
                                                            {{ $store->veg && !$store->non_veg ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group col-sm-6 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="tax" min="0" max="100"
                                                step="0.01" name="tax" class="form-control" required
                                                value="{{ $store->tax ?? '0' }}"
                                                {{ isset($store->tax) ? '' : 'readonly' }}>
                                        </div>
                                    </div>
                                    <div class="form-group col-sm-6 col-lg-4">
                                        <div class="form-group">
                                            <label
                                                ...
                                                <span>{{ translate('messages.admin_commission') }}(%) <span
                                                        class="input-label-secondary" data-toggle="tooltip"
                                                        data-placement="right"
                                                        data-original-title="{{ translate('messages.if_sales_commission_disabled_system_default_will_be_applicable') }}"><img
                                                            src="{{ asset('/assets/admin/img/info-circle.svg') }}"
                                                            alt="{{ translate('messages.if_sales_commission_disabled_system_default_will_be_applicable') }}"></span></span>
                                                <input type="checkbox" class="toggle-switch-input"
                                                    name="comission_status" id="comission_status" value="1"
                                                    {{ isset($store->comission) ? 'checked' : '' }}>
                                                <span class="toggle-switch-label">
                                                    <span class="toggle-switch-indicator"></span>
                                                </span>
                                            </label>
                                            <input type="number" id="comission" min="0" max="10000"
                                                step="0.01" name="comission" class="form-control" required
                                                value="{{ $store->comission ?? '0' }}"
                                                {{ isset($store->comission) ? '' : 'readonly' }}>
                                        </div>
                                    </div>
                                    <div class="col-12">
