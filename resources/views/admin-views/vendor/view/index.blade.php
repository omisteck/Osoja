            ...
            <div class="col-md-4">
                <div class="card h-100 card--bg-1">
                    ...
                    <div class="card-footer pt-0 bg-transparent border-0">
                        <a class="btn text-white text-capitalize bg--title h--45px w-100"
                            href="{{ $store->vendor->status ? route('admin.transactions.account-transaction.index') : '#' }}"
                            title="{{ translate('messages.goto') }} {{ translate('messages.account_transaction') }}">{{ translate('messages.collect_cash_from_store') }}</a>
                    </div>
                </div>
            </div>
            <div class="col-md-8">
                <div class="row g-3">
                    ...
                    <div class="col-sm-6">
                        <div class="resturant-card card--bg-4">
                            ...
                            <img class="resturant-icon w--30"
                                src="{{ asset('assets/admin/img/transactions/withdraw-balance.png') }}" alt="transaction">
                        </div>
                    </div>
                        ...
                        <div class="resturant--info-address">
                            ...
                            <ul class="address-info list-unstyled list-unstyled-py-3 text-dark">
                                ...
                                <li>
                                    ...
                                    <span>{{ translate('messages.address') }}</span> <span>:</span>
                                    <span>{{ $store->address }}</span>
                                </li>

                                <li>
                                    <i class="tio-call-talking nav-icon"></i>
                                    <span>{{ translate('messages.email') }}</span> <span>:</span>
                        ...
                        <div class="resturant--info-address">
                            <div class="avatar avatar-xxl avatar-circle avatar-border-lg">
                                <img class="avatar-img"
                                    ...
                                    src="{{ asset('storage/vendor') }}/{{ $store->vendor->image }}"
                        ...
                        <ul class="list-unstyled list-unstyled-py-3 text-dark">
                            @if ($store->vendor->bank_name)
                                <li class="pb-1 pt-1">
                                    ...
                                    {{ $store->vendor->bank_name ? $store->vendor->bank_name : 'No Data found' }}
                                </li>
                                <li class="pb-1 pt-1">
                                    <strong class="text--title">{{ translate('messages.branch') }} :</strong>
                                    {{ $store->vendor->branch ? $store->vendor->branch : 'No Data found' }}
                                </li>
                                <li class="pb-1 pt-1">
                                    <strong class="text--title">{{ translate('messages.holder_name') }} :</strong>
                                    {{ $store->vendor->holder_name ? $store->vendor->holder_name : 'No Data found' }}
                                </li>
                                <li class="pb-1 pt-1">
                                    <strong class="text--title">{{ translate('messages.account_no') }} :</strong>
                                    {{ $store->vendor->account_no ? $store->vendor->account_no : 'No Data found' }}
                                </li>
                            @else
                                <li class="my-auto">
