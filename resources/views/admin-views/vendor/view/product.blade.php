...
@section('content')
    <div class="content container-fluid">
        ...
        <!-- Page Heading -->
        <?php
    $foods = \App\Models\Item::withoutGlobalScope(\App\Scopes\StoreScope::class)->where('store_id', $store->id)->latest()->paginate(25);?>
                ...
                <div class="card">
                    <div class="card-header border-0 py-2">
                        <div class="search--button-wrapper">
                            <h3 class="card-title">
                                {{ translate('messages.items') }} <span class="badge badge-soft-dark ml-2"><span
                            ...
                            <div class="dropdown-divider"></div> --}}
                                    ...
                                    <a id="export-excel" class="dropdown-item"
                                        href="{{ route('admin.item.store-item-export', ['type' => 'excel', 'store_id' => $store->id]) }}">
                                        <img class="avatar avatar-xss avatar-4by3 mr-2"
                                    ...
                                    <a id="export-csv" class="dropdown-item"
                                        href="{{ route('admin.item.store-item-export', ['type' => 'csv', 'store_id' => $store->id]) }}">
                                        <img class="avatar avatar-xss avatar-4by3 mr-2"
                            ...
                            <a href="{{ route('admin.item.add-new') }}" class="btn btn--primary pull-right"><i
                                ...
                                {{ translate('messages.new') }} {{ translate('messages.item') }}</a>
                        </div>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <label class="toggle-switch toggle-switch-sm"
                                                ...
                                                <input type="checkbox"
                                                    onclick="location.href='{{ route('admin.item.status', [$food['id'], $food->status ? 0 : 1]) }}'"class="toggle-switch-input"
                                        ...
                                        <td>
                                            <div class="btn--container justify-content-center">
                                                ...
                                                <a class="btn action-btn btn--danger btn-outline-danger"
                                                    href="javascript:"
                                                    onclick="form_alert('food-{{ $food['id'] }}','{{ translate('messages.Want to delete this item ?') }}')"
