        ...
        <div class="row g-3 mb-3">
            ...
            <div class="col-xl-3 col-sm-6">
                <div class="resturant-card card--bg-2">
                    <?php
                    $active_stores = \App\Models\Store::where(['status' => 1])
                        ->where('module_id', Config::get('module.current_module_id'))
                        ->count(); ?>
        ...
        <ul class="transaction--information text-uppercase">
            ...
            <li class="text--danger">
                ...
                <div>
                    ...
                    <span>{{ translate('messages.total_store_withdraws') }}</span>
                            ...
                            <tr>
                                ...
                                <td>
                                    <label class="toggle-switch toggle-switch-sm"
                                        ...
                                        <input type="checkbox"
                                            onclick="location.href='{{ route('admin.store.featured', [$store->id, $store->featured ? 0 : 1]) }}'"
