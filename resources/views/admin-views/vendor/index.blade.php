                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title m-0 d-flex align-items-center">
                                <img class="mr-2 align-self-start w--20" src="{{ asset('assets/admin/img/resturant.png') }}"
                                    alt="instructions">
                            ...
                            <div class="row g-3 mb-0">
                                ...
                                <div class="col-lg-6 col-sm-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <textarea type="text" name="address" class="form-control h--45px"
                            ...
                            <div class="row g-3 my-0">
                                <div class="col-sm-6 col-lg-4">
                                    <div class="d-flex flex-column">
                                        <label class="input-label mb-0">{{ translate('messages.store') }}
                                        ...
                                        <center class="py-4 my-auto">
                                            <img class="img--120" id="viewer"
                                                src="{{ asset('assets/admin/img/100x100/1.png') }}"
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    <div class="d-flex flex-column">
                                        <label class="input-label mb-0">{{ translate('messages.upload') }}
                                            {{ translate('messages.cover') }} {{ translate('messages.photo') }} <span
                                        ...
                                        <div class="custom-file">
                                            ...
                                            <label class="custom-file-label"
                                                for="coverImageUpload">{{ translate('messages.choose') }}
                                                {{ translate('messages.file') }}</label>
                                        </div>
                                    </div>
                                </div>
...
@push('script_2')
    ...
    <script>
        $('#reset_btn').click(function() {
            ...
            $('#coverImageViewer').attr('src', "{{ asset('assets/admin/img/900x400/img1.jpg') }}");
