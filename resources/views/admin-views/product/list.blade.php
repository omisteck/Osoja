            ...
            <div class="row align-items-center g-2">
                <div class="col-md-9 col-12">
                    <h1 class="page-header-title">
                        ...
                        <span>
                            {{ translate('messages.item') }} {{ translate('messages.list') }} <span
                                class="badge badge-soft-dark ml-2" id="foodCount">{{ $items->total() }}</span>
                        </span>
                    </h1>
                </div>
                    ...
                    <div class="hs-unfold mr-2">
                        ...
                        <div id="usersExportDropdown"
                            ...
                            <a id="export-excel" class="dropdown-item"
                                href="{{ url('/') }}/admin/item/export/excel?{{ parse_url(url()->full(), PHP_URL_QUERY) }}">
                                <img class="avatar avatar-xss avatar-4by3 mr-2"
                                    src="{{ asset('assets/admin') }}/svg/components/excel.svg" alt="Image Description">
                                {{ translate('messages.excel') }}
                            </a>
                            <a id="export-csv" class="dropdown-item"
                                href="{{ url('/') }}/admin/item/export/csv?{{ parse_url(url()->full(), PHP_URL_QUERY) }}">
                                <img class="avatar avatar-xss avatar-4by3 mr-2"
