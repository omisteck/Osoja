                ...
                <div class="col-md-6">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <label class="text-dark mt-3">{{ translate('messages.item') }}
                                {{ translate('messages.thumbnail') }} <small class="text-danger">* (
                                        ...
                                        <select name="module_id" required class="form-control js-select2-custom"
                                            ...
                                            @foreach (\App\Models\Module::notParcel()->get() as $module)
                                                <option value="{{ $module->id }}"
                                                    {{ $module->id == $product->module_id ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group mb-0">
                                        <label class="input-label"
                                            for="exampleFormControlSelect1">{{ translate('messages.addon') }}<span
                                                class="input-label-secondary"
                                                title="{{ translate('messages.store_required_warning') }}"><img
                                                    src="{{ asset('/assets/admin/img/info-circle.svg') }}"
