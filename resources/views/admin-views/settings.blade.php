                ...
                <form action="{{ env('APP_MODE') != 'demo' ? route('admin.settings') : 'javascript:' }}" method="post"
                    ...
                    <div class="card mb-3 mb-lg-5" id="generalDiv">
                        ...
                        <label class="avatar avatar-xxl avatar-circle avatar-border-lg avatar-uploader profile-cover-avatar"
                            for="avatarUploader">
                            <img id="viewer" onerror="this.src='{{ asset('assets/admin/img/160x160/img1.jpg') }}'"
                                class="avatar-img" src="{{ asset('storage/admin') }}/{{ auth('admin')->user()->image }}"
                                alt="Image">
                    ...
                    <div class="card mb-3 mb-lg-5">
                        <div class="card-header">
                            <h2 class="card-title h4"><i class="tio-info"></i>
                                {{ translate('messages.basic_information') }}</h2>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row form-group">
                                <label for="firstNameLabel"
                                    class="col-sm-3 col-form-label input-label d-flex"><span>{{ translate('messages.full_name') }}</span>
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="button"
                                    onclick="{{ env('APP_MODE') != 'demo' ? "form_alert('admin-settings-form','Want to update admin info ?')" : 'call_demo()' }}"
                        ...
                        <form id="changePasswordForm"
                            ...
                            <div class="row form-group">
                                <label for="newPassword"
                                    class="col-sm-3 col-form-label input-label">{{ translate('messages.new_password') }}</label>
                                ...
                                <div class="col-sm-9">
                                    <div class="mb-3">
                                        <input type="password" class="form-control" name="confirm_password"
                                            ...
                                            placeholder="{{ translate('messages.confirm_new_password') }}"
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="button"
                                    onclick="{{ env('APP_MODE') != 'demo' ? "form_alert('changePasswordForm','" . translate('messages.want_to_update_admin_password') . "')" : 'call_demo()' }}"
                                    class="btn btn-primary">{{ translate('messages.save') }}</button>
                            </div>
                        </form>
                        <!-- End Form -->
