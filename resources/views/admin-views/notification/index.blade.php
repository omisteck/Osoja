                            ...
                            <div class="row gy-3">
                                <div class="col-lg-6">
                                    <div class="row g-2">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group mb-0">
                                                <label class="input-label" for="tergat">{{ translate('messages.send') }}
                                                    {{ translate('messages.to') }}</label>

                                                <select name="tergat" class="form-control" id="tergat"
                                                    data-placeholder="{{ translate('messages.select') }} {{ translate('messages.tergat') }}"
                                                    required>
                                ...
                                <div class="col-12">
                                    <div class="btn--container justify-content-end">
                                        ...
                                        <button type="submit" id="submit"
                                            class="btn btn--primary">{{ translate('messages.send') }}
                                            {{ translate('messages.notification') }}</button>
                                    </div>
                                </div>
                            </div>
                        </form>
                            ...
                            <div class="hs-unfold mr-2">
                                ...
                                <div id="usersExportDropdown"
                                    ...
                                    <a id="export-excel" class="dropdown-item"
                                        href="{{ route('admin.notification.export', ['type' => 'excel']) }}">
                                        <img class="avatar avatar-xss avatar-4by3 mr-2"
                                    ...
                                    <a id="export-csv" class="dropdown-item"
                                        href="{{ route('admin.notification.export', ['type' => 'csv']) }}">
                                        <img class="avatar avatar-xss avatar-4by3 mr-2"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <label class="toggle-switch toggle-switch-sm"
                                                ...
                                                <input type="checkbox"
                                                    onclick="location.href='{{ route('admin.notification.status', [$notification['id'], $notification->status ? 0 : 1]) }}'"class="toggle-switch-input"
                                        ...
                                        <td>
                                            <div class="btn--container justify-content-center">
                                                <a class="btn action-btn btn--primary btn-outline-primary"
                                                    ...
                                                    title="{{ translate('messages.edit') }} {{ translate('messages.notification') }}"><i
                                                        class="tio-edit"></i>
                                                </a>
                                                <a class="btn action-btn btn--danger btn-outline-danger"
                                                    href="javascript:"
                                                    onclick="form_alert('notification-{{ $notification['id'] }}','{{ translate('Want to delete this notification ?') }}')"
                                                    title="{{ translate('messages.delete') }} {{ translate('messages.notification') }}"><i
