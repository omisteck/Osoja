                            ...
                            <div class="row g-2">
                                <div class="col-12">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="text" value="{{ $notification['title'] }}" name="notification_title"
                                            class="form-control" placeholder="{{ translate('messages.new_notification') }}"
                                ...
                                <div class="col-12">
                                    <div class="form-group mb-0">
                                        ...
                                        <select name="zone" id="zone" class="form-control js-select2-custom">
                                            <option value="" {{ isset($notification->zone_id) ? '' : 'selected' }}>
                                                {{ translate('messages.all') }} {{ translate('messages.zone') }}</option>
                                            @foreach (\App\Models\Zone::orderBy('name')->get() as $z)
                                                <option value="{{ $z['id'] }}"
                                                    {{ $notification->zone_id == $z['id'] ? 'selected' : '' }}>
                                                    {{ $z['name'] }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <select name="tergat" class="form-control" id="tergat"
                                            ...
                                            <option value="customer"
                                                {{ $notification->tergat == 'customer' ? 'selected' : '' }}>
                                                {{ translate('messages.customer') }}</option>
                                            <option value="deliveryman"
                                                {{ $notification->tergat == 'deliveryman' ? 'selected' : '' }}>
                                                {{ translate('messages.deliveryman') }}</option>
                                            <option value="store"
                                                {{ $notification->tergat == 'store' ? 'selected' : '' }}>
                            ...
                            <div class="h-100 d-flex flex-column">
                                ...
                                <center class="py-3 my-auto">
                                    <img class="img--vertical" id="viewer"
                                        ...
                                        onerror="src='{{ asset('assets/admin/img/900x400/img1.jpg') }}'" alt="image" />
                                </center>
...
@push('script_2')
    ...
    <script>
        $('#reset_btn').click(function() {
            ...
            $('#viewer').attr('src',
                "{{ asset('storage/notification') }}/{{ $notification['image'] }}");
        })
    </script>
@endpush
