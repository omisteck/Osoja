                    ...
                    <div class="row g-2" id="order_stats">
                        <div class="col-sm-6 col-lg-3">
                            <div class="__dashboard-card-2">
                                <img src="{{ asset('/assets/admin/img/dashboard/grocery/items.svg') }}"
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="__dashboard-card-2">
                                <img src="{{ asset('/assets/admin/img/dashboard/grocery/orders.svg') }}"
                                    alt="dashboard/grocery">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="__dashboard-card-2">
                                <img src="{{ asset('/assets/admin/img/dashboard/grocery/stores.svg') }}"
                                    alt="dashboard/grocery">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="__dashboard-card-2">
                                <img src="{{ asset('/assets/admin/img/dashboard/grocery/customers.svg') }}"
                                    alt="dashboard/grocery">
