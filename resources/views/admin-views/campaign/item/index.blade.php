                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <center id="image-viewer-section" class="py-3 my-auto">
                                <img class="img--120" id="viewer" src="{{ asset('assets/admin/img/100x100/2.png') }}"
                                    alt="banner image" />
                            </center>
                        ...
                        <div class="card-body">
                            <div class="row g-2">
                                ...
                                <div class="col-md-3 col-sm-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <select name="store_id" class="js-data-example-ajax form-control" id="store_id"
                                            ...
                                            data-original-title="Select Store" required>
                                ...
                                <div class="col-md-3 col-sm-6">
                                    <div class="form-group mb-0">
                                        <label class="input-label"
                                            for="exampleFormControlSelect1">{{ translate('messages.sub_category') }}
                                            <span class="input-label-secondary" data-toggle="tooltip"
                                                data-placement="right"
                                                data-original-title="{{ translate('messages.category_required_warning') }}">
                                                <img src="{{ asset('/assets/admin/img/info-circle.svg') }}"
                                                    alt="{{ translate('messages.category_required_warning') }}">
                                            </span>
                                        </label>
                            ...
                            <div class="row g-2">
                                <div class="col-md-3 col-sm-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="number" min=".01" max="100000" step="0.01"
