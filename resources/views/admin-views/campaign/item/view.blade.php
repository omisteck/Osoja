            ...
            <div class="card-body">
                <div class="row align-items-md-center">
                    <div class="col-md-6 col-lg-4 mb-3 mb-md-0">
                        <img class="rounded img--ratio-3" src="{{ asset('storage/campaign') }}/{{ $campaign['image'] }}"
                            onerror="this.src='{{ asset('/assets/admin/img/900x400/img1.jpg') }}'" alt="Image Description">
                    </div>
                    <div class="col-md-6">
                        <span class="d-block mb-1">
                            {{ translate('messages.campaign') }} {{ translate('messages.starts') }}
                            {{ translate('messages.from') }} :
                            <strong class="text--title">{{ $campaign->start_date->format('Y-M-d') }}</strong>
                        </span>
                        <span class="d-block mb-1">
                            {{ translate('messages.campaign') }} {{ translate('messages.ends') }}
                            {{ translate('messages.at') }} :
                            ...
                            <thead class="thead-light">
                                <tr>
                                    <th class="px-4 border-0 w--120px">
                                        <h4 class="m-0">{{ translate('messages.short') }}
                                            {{ translate('messages.description') }}</h4>
                                    </th>
                                    <th class="px-4 border-0 w--120px">
                                ...
                                <tr>
                                    ...
                                    <td class="px-4">
                                        <div>
                                            ...
                                            <span class="d-block text-dark">Price :
