                        ...
                        <div id="{{ $default_lang }}-form">
                            <div class="form-group">
                                ...
                                <input type="text" name="title[]" class="form-control"
                                    placeholder="{{ translate('messages.new_campaign') }}"
                                    value="{{ $campaign['title'] }}" maxlength="100" required>
                            </div>
                    ...
                    <div class="row g-3">
                        <div class="col-lg-6">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div>
                                        <label class="input-label text-capitalize"
                                            for="title">{{ translate('messages.daily') }}
                                            {{ translate('messages.start') }} {{ translate('messages.time') }}</label>
                                ...
                                <div class="col-sm-6">
                                    <label class="input-label text-capitalize"
                                        for="title">{{ translate('messages.daily') }} {{ translate('messages.end') }}
