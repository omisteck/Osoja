...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('admin.business-settings.module.store') }}" method="post"
                    ...
                    @if ($language)
                        @foreach (json_decode($language) as $lang)
                            <div class="{{ $lang != $default_lang ? 'd-none' : '' }} lang_form p-1 mb-2"
                                id="{{ $lang }}-form">
                                <div class="form-group">
                                    <label class="input-label text-capitalize"
                                        for="exampleFormControlInput1">{{ translate('messages.module') }}
                                        {{ translate('messages.name') }} ({{ strtoupper($lang) }})</label>
                                    <input type="text" name="module_name[]" class="form-control" maxlength="191"
                                        {{ $lang == $default_lang ? 'required' : '' }}
                                        oninvalid="document.getElementById('en-link').click()"
                                        placeholder="{{ translate('messages.Ex:') }} {{ translate('Module Name') }}">
                                </div>
                                <div class="form-group">
                                    <label class="input-label" for="module_type">{{ translate('messages.description') }}
                                        ({{ strtoupper($lang) }})
                                    </label>
                    ...
                    @else
                        <div class="form-group">
                            <label class="input-label" for="exampleFormControlInput1">{{ translate('messages.module') }}
                            ...
                            <input type="text" name="module_name" class="form-control"
                                ...
                                placeholder="{{ translate('messages.Ex:') }} {{ translate('messages.Module Name') }}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="input-label"
                                    for="module_type">{{ translate('messages.module_type') }}</label>
                                <select name="module_type" id="module_type" class="form-control text-capitalize"
                                    onchange="modulChange(this.value)">
                                    <option disabled selected>{{ translate('messages.select') }}
                                        {{ translate('messages.module_type') }}</option>
                    ...
                    <div class="form-group" id="module_theme">
                        ...
                        <div class="row g-4">
                            <div class='col-lg-3 col-sm-6 col-12 text-center'>
                                <input type="radio" name="theme" require id="img1" class="d-none imgbgchk"
                                    value="1">
                                <label for="img1">
                                    <img class="img-thumbnail rounded" src="{{ asset('assets/admin/img/Theme-1.png') }}"
                                        alt="Image 1">
                                </label>
                            </div>
                            <div class='col-lg-3 col-sm-6 col-12 text-center'>
                                <input type="radio" name="theme" require id="img2" class="d-none imgbgchk"
                                    value="2">
                                <label for="img2">
                                    <img class="img-thumbnail rounded" src="{{ asset('assets/admin/img/Theme-2.png') }}"
                                        alt="Image 2">
                                </label>
                            </div>
                            <div class="col-lg-6">
                            ...
                            <div class="row h-100">
                                <div class="col-sm-6 mb-4 mb-sm-0">
                                    <div class="form-group m-0 h-100 d-flex flex-column justify-content-center">
                                        ...
                                        <div class="custom-file">
                                            <input type="file" name="icon" id="customFileEg1"
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group m-0 h-100 d-flex flex-column justify-content-center">
                                        ...
                                        <center class="my-auto py-3">
                                            <img class="initial--15" id="viewer2"
                                                src="{{ asset('assets/admin/img/400x400/img2.jpg') }}" alt="image" />
                                        </center>
                                        <div class="custom-file">
                                            <input type="file" name="thumbnail" id="customFileEg2"
                                                class="custom-file-input"
                                                accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*" required>
                                            <label class="custom-file-label"
