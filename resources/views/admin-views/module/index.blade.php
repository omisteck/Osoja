                    ...
                    <div class="hs-unfold mr-2">
                        ...
                        <div class="dropdown-divider"></div> --}}
                            ...
                            <a id="export-excel" class="dropdown-item"
                                href="{{ route('admin.business-settings.module.export', ['type' => 'excel']) }}">
                                <img class="avatar avatar-xss avatar-4by3 mr-2"
                                    src="{{ asset('assets/admin') }}/svg/components/excel.svg" alt="Image Description">
                                {{ translate('messages.excel') }}
                            </a>
                            <a id="export-csv" class="dropdown-item"
                                href="{{ route('admin.business-settings.module.export', ['type' => 'csv']) }}">
                                <img class="avatar avatar-xss avatar-4by3 mr-2"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label class="toggle-switch toggle-switch-sm"
                                            for="stocksCheckbox{{ $module->id }}">
                                            <input type="checkbox"
                                                onclick="location.href='{{ route('admin.business-settings.module.status', [$module['id'], $module->status ? 0 : 1]) }}'"class="toggle-switch-input"
                                                id="stocksCheckbox{{ $module->id }}"
