...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('admin.business-settings.module.update', [$module['id']]) }}" method="post"
                            ...
                            <div class="{{ $lang != $default_lang ? 'd-none' : '' }} lang_form"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="module_name[]" class="form-control" maxlength="191"
                                        value="{{ $lang == $default_lang ? $module['module_name'] : $translate[$lang]['module_name'] ?? '' }}"
                            ...
                            <div class="form-group">
                                ...
                                <select name="module_type" id="module_type" class="form-control text-capitalize" disabled>
                                    @foreach (config('module.module_type') as $key)
                                        <option value="{{ $key }}"
                                            {{ $key == $module->module_type ? 'selected' : '' }}>{{ $key }}
                                        </option>
                                    @endforeach
                                </select>
                                <div class="card mt-1" id="module_des_card">
                                    <div class="card-body" id="module_description">
                                        {{ config('module.' . $module->module_type)['description'] }}</div>
                                </div>
                            </div>
                        </div>
                        {{-- <div class="col-sm-6">
                        ...
                        <div class="row">
                            <div class='col-lg-3 col-sm-6 col-12 text-center'>
                                <input type="radio" name="theme" require id="img1" class="d-none imgbgchk"
                                    value="1" {{ $module->theme_id == 1 ? 'checked' : '' }}>
                                <label for="img1">
                            ...
                            <div class='col-lg-3 col-sm-6 col-12 text-center'>
                                <input type="radio" name="theme" require id="img2" class="d-none imgbgchk"
                                    value="2" {{ $module->theme_id == 2 ? 'checked' : '' }}>
                                <label for="img2">
                                    ...
                                    <div class="form-group m-0 h-100 d-flex flex-column justify-content-center">
                                        ...
                                        <center class="my-auto py-3">
                                            <img class="initial--15 " id="viewer"
                                                ...
                                                src="{{ asset('storage/module/' . $module['icon']) }}" alt="image" />
                                        </center>
                                        <div class="custom-file">
                                    ...
                                    <div class="form-group m-0 h-100 d-flex flex-column justify-content-center">
                                        ...
                                        <center class="my-auto py-3">
                                            <img class="initial--15 " id="viewer2"
                                                onerror="this.src='{{ asset('assets/admin/img/400x400/img2.jpg') }}'"
                                                src="{{ asset('storage/module/' . $module['thumbnail']) }}"
                                                alt="image" />
                                        </center>
                                        <div class="custom-file">
