                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="w-0 flex-grow pl-3">
                                ...
                                <p class="page-header-text m-0">
                                    {{ translate('Hello, here you can manage your users by zone.') }}</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <select name="zone_id" class="form-control js-select2-custom"
                            ...
                            @foreach (\App\Models\Zone::orderBy('name')->get() as $zone)
                                <option value="{{ $zone['id'] }}"
                                    {{ $params['zone_id'] == $zone['id'] ? 'selected' : '' }}>
                                    {{ $zone['name'] }}
                                </option>
                            @endforeach
                        </select>
                        ...
                        <div class="row gap__10">
                            <div class="col-md-12 col-sm-6">
                                <div class="__customer-statistics-card">
                                    ...
                                    <h4 class="subtitle text-capitalize">{{ translate('messages.active_customer') }}
                                    </h4>
                                </div>
                            </div>
                            <div class="col-md-12 col-sm-6">
                            ...
                            <div class="col-md-12 col-sm-6">
                                <div class="__customer-statistics-card" style="--clr:#FF5A54">
                                    ...
                                    <h4 class="subtitle text-capitalize">{{ translate('messages.blocked_customer') }}
                                    </h4>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body pb-0">
                                <div class="d-flex flex-wrap justify-content-between align-items-center __gap-12px">
                                    <div class="__gross-amount">
                                        {{-- <h6>$855.8K</h6> --}}
                                        <span
                                            class="text-capitalize">{{ translate('messages.customer_growth') }}</span>
                                    </div>
                ...
                <div class="__customer-satisfaction">
                    <div class="px-2">
                        ...
                        <div class="px-sm-2">
                            ...
                            <span
                                class="review-received text-capitalize">{{ translate('messages.review_received') }}</span>
                        </div>
                    </div>
                    <ul class="__customer-review">
                        <li>
                            ...
                            <span class="review">
                                <i class="tio-user-big"
                                    @if ($positive_parcent >= 5) style="--clr:#00AA6D;" @endif></i>
                                <i class="tio-user-big"
                                    @if ($positive_parcent >= 20) style="--clr:#00AA6D;" @endif></i>
                                <i class="tio-user-big"
                                    @if ($positive_parcent >= 30) style="--clr:#00AA6D;" @endif></i>
                                <i class="tio-user-big"
                                    @if ($positive_parcent >= 40) style="--clr:#00AA6D;" @endif></i>
                                <i class="tio-user-big"
                                    @if ($positive_parcent >= 50) style="--clr:#00AA6D;" @endif></i>
                                <i class="tio-user-big"
                                    @if ($positive_parcent >= 60) style="--clr:#00AA6D;" @endif></i>
                                <i class="tio-user-big"
                                    @if ($positive_parcent >= 70) style="--clr:#00AA6D;" @endif></i>
                                <i class="tio-user-big"
                                    @if ($positive_parcent >= 80) style="--clr:#00AA6D;" @endif></i>
                                <i class="tio-user-big"
                                    @if ($positive_parcent >= 87) style="--clr:#00AA6D;" @endif></i>
                                <i class="tio-user-big"
                                    @if ($positive_parcent >= 95) style="--clr:#00AA6D;" @endif></i>
                            </span>
                        ...
                        <li>
                            ...
                            <span class="review">
                                <i class="tio-user-big"
                                    @if ($good_parcent >= 5) style="--clr:#FEB019;" @endif></i>
                                <i class="tio-user-big"
                                    @if ($good_parcent >= 20) style="--clr:#FEB019;" @endif></i>
                                <i class="tio-user-big"
                                    @if ($good_parcent >= 30) style="--clr:#FEB019;" @endif></i>
                                <i class="tio-user-big"
                                    @if ($good_parcent >= 40) style="--clr:#FEB019;" @endif></i>
                                <i class="tio-user-big"
                                    @if ($good_parcent >= 50) style="--clr:#FEB019;" @endif></i>
                                <i class="tio-user-big"
                                    @if ($good_parcent >= 60) style="--clr:#FEB019;" @endif></i>
                                <i class="tio-user-big"
                                    @if ($good_parcent >= 70) style="--clr:#FEB019;" @endif></i>
                                <i class="tio-user-big"
                                    @if ($good_parcent >= 80) style="--clr:#FEB019;" @endif></i>
                                <i class="tio-user-big"
                                    @if ($good_parcent >= 87) style="--clr:#FEB019;" @endif></i>
                                <i class="tio-user-big"
                                    @if ($good_parcent >= 95) style="--clr:#FEB019;" @endif></i>
                            </span>
                        ...
                        <li>
                            ...
                            <span class="review">
                                <i class="tio-user-big"
                                    @if ($neutral_parcent >= 5) style="--clr:#0177CD;" @endif></i>
                                <i class="tio-user-big"
                                    @if ($neutral_parcent >= 20) style="--clr:#0177CD;" @endif></i>
                                <i class="tio-user-big"
                                    @if ($neutral_parcent >= 30) style="--clr:#0177CD;" @endif></i>
                                <i class="tio-user-big"
                                    @if ($neutral_parcent >= 40) style="--clr:#0177CD;" @endif></i>
                                <i class="tio-user-big"
                                    @if ($neutral_parcent >= 50) style="--clr:#0177CD;" @endif></i>
                                <i class="tio-user-big"
                                    @if ($neutral_parcent >= 60) style="--clr:#0177CD;" @endif></i>
                                <i class="tio-user-big"
                                    @if ($neutral_parcent >= 70) style="--clr:#0177CD;" @endif></i>
                                <i class="tio-user-big"
                                    @if ($neutral_parcent >= 80) style="--clr:#0177CD;" @endif></i>
                                <i class="tio-user-big"
                                    @if ($neutral_parcent >= 87) style="--clr:#0177CD;" @endif></i>
                                <i class="tio-user-big"
                                    @if ($neutral_parcent >= 95) style="--clr:#0177CD;" @endif></i>
                            </span>
                        ...
                        <li>
                            ...
                            <span class="review">
                                <i class="tio-user-big"
                                    @if ($negative_percent >= 5) style="--clr:#FF7E7E;" @endif></i>
                                <i class="tio-user-big"
                                    @if ($negative_percent >= 20) style="--clr:#FF7E7E;" @endif></i>
                                <i class="tio-user-big"
                                    @if ($negative_percent >= 30) style="--clr:#FF7E7E;" @endif></i>
                                <i class="tio-user-big"
                                    @if ($negative_percent >= 40) style="--clr:#FF7E7E;" @endif></i>
                                <i class="tio-user-big"
                                    @if ($negative_percent >= 50) style="--clr:#FF7E7E;" @endif></i>
                                <i class="tio-user-big"
                                    @if ($negative_percent >= 60) style="--clr:#FF7E7E;" @endif></i>
                                <i class="tio-user-big"
                                    @if ($negative_percent >= 70) style="--clr:#FF7E7E;" @endif></i>
                                <i class="tio-user-big"
                                    @if ($negative_percent >= 80) style="--clr:#FF7E7E;" @endif></i>
                                <i class="tio-user-big"
                                    @if ($negative_percent >= 87) style="--clr:#FF7E7E;" @endif></i>
                                <i class="tio-user-big"
                                    @if ($negative_percent >= 95) style="--clr:#FF7E7E;" @endif></i>
                            </span>
        ...
        for (var i = 0; i < deliveryMan.length; i++) {
            if (deliveryMan[i].lat) {
                var contentString =
                    ...
                    deliveryMan[i].image + "'></div><div style='float:right; padding: 10px;'><b>" + deliveryMan[i]
                ...
                google.maps.event.addListener(marker, 'click', (function(marker, i) {
                    return function() {
                        infowindow.setContent(
                            ...
                            .name + "</b><br/> " + deliveryMan[i].location + "</b><br/> " +
                            'Assigned Order: ' + deliveryMan[i].assigned_order_count + "</div>"
                        );
