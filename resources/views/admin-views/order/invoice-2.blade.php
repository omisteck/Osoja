        ...
        <div class="content container-fluid">
            ...
            <div class="row">
                <div class="col-4">
                    ...
                    <br><br>
                    <strong>Phone :
                        {{ \App\Models\BusinessSetting::where(['key' => 'phone'])->first()->value }}</strong><br>
                    <strong>Email :
                        {{ \App\Models\BusinessSetting::where(['key' => 'email_address'])->first()->value }}</strong><br>
                    <strong>Address :
                        {{ \App\Models\BusinessSetting::where(['key' => 'address'])->first()->value }}</strong><br><br>
                </div>
                <div class="col-4"></div>
                <div class="col-4">
                    @if ($order->customer)
                                        ...
                                        <div class="media-body">
                                            <div class="row">
                                                ...
                                                <div class="col col-md-2 align-self-center">
                                                    ...
                                                    @endif
                                                    <h6>{{ \App\CentralLogics\Helpers::format_currency($detail['price'] - $detail['discount_on_product']) }}
                                                    </h6>
                                                </div>
                            ...
                            <div class="row justify-content-md-end mb-3">
                                <div class="col-md-9 col-lg-8">
                                    <dl class="row text-sm-right">
                                        ...
                                        <dd class="col-sm-6">
                                            {{ \App\CentralLogics\Helpers::format_currency($total_tax) }}</dd>
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col">
                    <p class="font-size-sm mb-0">
                        &copy; {{ \App\Models\BusinessSetting::where(['key' => 'restaurant_name'])->first()->value }}.
                        <span
