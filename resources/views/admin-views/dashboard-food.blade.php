                    ...
                    <div class="row g-2" id="order_stats">
                        <div class="col-sm-6 col-lg-3">
                            <div class="__dashboard-card-2">
                                <img src="{{ asset('/assets/admin/img/dashboard/food/items.svg') }}"
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="__dashboard-card-2">
                                <img src="{{ asset('/assets/admin/img/dashboard/food/orders.svg') }}"
                                    alt="dashboard/grocery">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="__dashboard-card-2">
                                <img src="{{ asset('/assets/admin/img/dashboard/food/stores.svg') }}"
                                    alt="dashboard/grocery">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="__dashboard-card-2">
                                <img src="{{ asset('/assets/admin/img/dashboard/food/customers.svg') }}"
                                    alt="dashboard/grocery">
