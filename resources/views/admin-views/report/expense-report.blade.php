    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            ...
            <div class="__page-header-txt">
                This report shows the delivery fee for all orders whose delivery fee is free for using "free delivery over"
                or "free delivery coupon".
            </div>
                        ...
                        <tbody id="set-rows">
                            @foreach ($expense as $key => $exp)
                                <tr>
                                    ...
                                    <td><label class="text-uppercase">{{ translate("messages.{$exp['type']}") }}</label>
                                    </td>
