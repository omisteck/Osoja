        ...
        <div class="row card mt-4">
            ...
            <div class="card-header border-0 py-2">
                <div class="search--button-wrapper">
                    <h3 class="card-title">
                        {{ translate('Item report table') }}<span class="badge badge-soft-secondary"
                            id="countItems">{{ $items->total() }}</span>
                    </h3>
                    ...
                    <div class="hs-unfold mr-2">
                        ...
                        <div id="usersExportDropdown"
                            ...
                            <a id="export-excel" class="dropdown-item"
                                href="{{ route('admin.transactions.report.item-wise-export', ['type' => 'excel', request()->getQueryString()]) }}">
                                <img class="avatar avatar-xss avatar-4by3 mr-2"
                                    src="{{ asset('assets/admin') }}/svg/components/excel.svg" alt="Image Description">
                                {{ translate('messages.excel') }}
                            </a>
                            <a id="export-csv" class="dropdown-item"
                                href="{{ route('admin.transactions.report.item-wise-export', ['type' => 'csv', request()->getQueryString()]) }}">
                                <img class="avatar avatar-xss avatar-4by3 mr-2"
                    ...
                    <tbody id="set-rows">
                        ...
                        @foreach ($items as $key => $item)
                            <tr>
                                ...
                                <td>
                                    <div class="rating">
                                        <span><i class="tio-star"></i></span>{{ round($item->avg_rating, 1) }}
                                        ({{ $item->rating_count }})
                                    </div>
                                </td>
                            </tr>
