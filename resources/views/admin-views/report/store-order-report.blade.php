                ...
                <form action="{{ route('admin.transactions.report.set-date') }}" method="post">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <select class="form-control" name="filter"
                                ...
                                <option value="previous_year"
                                    ...
                                    {{ translate('messages.Previous Year') }}
                                </option>
                        ...
                        @if (isset($filter) && $filter == 'custom')
                            ...
                            <div class="col-md-4 col-sm-6">
                                <button type="submit"
                                    class="btn btn--primary btn-block">{{ translate('show_data') }}</button>
                            </div>
                        @endif
                    </div>
                </form>
            ...
            <div class="left-content">
                ...
                <div class="left-content-card">
                    ...
                    <div class="coupon__discount w-100 text-right d-flex justify-content-between">
                        <div>
                            <strong
                                class="text-danger">{{ \App\CentralLogics\Helpers::number_format_short($total_canceled) }}</strong>
                        ...
                        <div>
                            <strong
                                class="text-success">{{ \App\CentralLogics\Helpers::number_format_short($total_delivered) }}</strong>
                            <div>
                                {{ translate('Completed') }}
                            </div>
                        </div>
                ...
                <div class="card h-100 bg-white payment-statistics-shadow">
                    ...
                    <div class="card-body px-0 pt-0">
                        ...
                        <div class="earning-statistics-content mt-3">
                            <a href="{{ route('admin.order.list', ['all']) }}"
                                class="trx-btn">{{ translate('View All Orders') }}</a>
                        </div>
                    </div>
                </div>
                <!-- Dognut Pie -->
