                    ...
                    <table class="table table-borderless middle-align __txt-14px">
                        <thead class="thead-light white--space-false">
                            <tr>
                                ...
                                <th class="border-top border-bottom text-capitalize">{{ translate('Transaction Amount') }}
                                </th>
                                <th class="border-top border-bottom text-capitalize pl-0">{{ translate('Reference') }}
                                </th>
                                <th class="border-top border-bottom text-capitalize pl-0">
