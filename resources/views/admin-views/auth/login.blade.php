                    ...
                    <form class="" action="{{ route('admin.auth.login') }}" method="post" id="form-id">
                        ...
                        <div class="auth-header">
                            <div class="mb-5">
                                ...
                                <p class="mb-0">{{ translate('messages.want') }} {{ translate('messages.to') }}
                            ...
                            <div class="row p-2">
                                <div class="col-6 pr-0">
                                    <input type="text" class="form-control form-control-lg border-0"
                                        ...
                                        placeholder="{{ \translate('Enter recaptcha value') }}" autocomplete="off"
                        ...
                        <button type="submit"
                            class="btn btn-lg btn-block btn--primary mt-xxl-3">{{ translate('messages.login') }}</button>
                    </form>
                    <!-- End Form -->
