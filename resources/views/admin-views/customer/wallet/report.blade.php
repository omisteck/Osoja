                        ...
                        <tbody>
                            @foreach ($transactions as $k => $wt)
                                <tr scope="row">
                                    ...
                                    <td><a
                                            href="{{ route('admin.users.customer.view', ['user_id' => $wt->user_id]) }}">{{ Str::limit($wt->user ? $wt->user->f_name . ' ' . $wt->user->l_name : __('messages.not_found'), 20, '...') }}</a>
                                    </td>
                                    <td>{{ $wt->credit }}</td>
                                    <td>{{ $wt->debit }}</td>
                                    <td>{{ $wt->balance }}</td>
                                    ...
                                    <td>
                                        ...
                                        <span
                                            class="d-block">{{ date(config('timeformat'), strtotime($wt['created_at'])) }}</span>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
