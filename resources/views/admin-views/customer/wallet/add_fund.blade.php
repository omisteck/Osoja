...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="card gx-2 gx-lg-3">
            <div class="card-body">
                <form action="{{ route('admin.users.customer.wallet.add-fund') }}" method="post"
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <label class="input-label" for="referance">{{ translate('messages.reference') }}
                                    <small>({{ translate('messages.optional') }})</small></label>
