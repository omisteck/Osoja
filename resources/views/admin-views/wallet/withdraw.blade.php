        ...
        <div class="page-header">
            <h1 class="page-header-title mr-3 mb-md-0">
                ...
                <span>
                    ...
                    {{ translate('messages.transaction') }} <span class="badge badge-soft-dark ml-2"
                        id="itemCount">{{ $withdraw_req->total() }}</span>
                </span>
            </h1>
        </div>
        <!-- Page Heading -->
                    ...
                    <div class="hs-unfold mr-2">
                        ...
                        <div id="usersExportDropdown"
                            ...
                            <a id="export-excel" class="dropdown-item"
                                href="{{ route('admin.transactions.store.withdraw_export', ['type' => 'excel', request()->getQueryString()]) }}">
                                <img class="avatar avatar-xss avatar-4by3 mr-2"
                                    src="{{ asset('assets/admin') }}/svg/components/excel.svg" alt="Image Description">
                                {{ translate('messages.excel') }}
                            </a>
                            <a id="export-csv" class="dropdown-item"
                                href="{{ route('admin.transactions.store.withdraw_export', ['type' => 'csv', request()->getQueryString()]) }}">
                                <img class="avatar avatar-xss avatar-4by3 mr-2"
