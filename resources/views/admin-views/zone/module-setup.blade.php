                    ...
                    <div class="check--item-wrapper mb-1">
                        <div class="check-item">
                            <div class="form-group form-check form--check">
                                <input type="checkbox" name="cash_on_delivery" value="cash_on_delivery"
                                    class="form-check-input" id="cash_on_delivery"
                                    {{ $zone->cash_on_delivery == 1 ? 'checked' : '' }}>
                                <label class="form-check-label qcont text-dark"
                                    for="cash_on_delivery">{{ translate('messages.Cash On Delivery') }}</label>
                            </div>
                        </div>
                        <div class="check-item">
                            <div class="form-group form-check form--check">
                                <input type="checkbox" name="digital_payment" value="digital_payment"
                                    class="form-check-input" id="digital_payment"
                                    {{ $zone->digital_payment == 1 ? 'checked' : '' }}>
                                <label class="form-check-label qcont text-dark"
                                    for="digital_payment">{{ translate('messages.digital payment') }}</label>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-12">
                    <div class="delivery_charge_options" id="delivery_charge_options">
                        <div class="row gy-1" id="mod-label">
                            ...
                            <div class="col-sm-3">
                                <label for="">{{ translate('messages.per_km_delivery_charge') }}
                                    ({{ \App\CentralLogics\Helpers::currency_symbol() }})</label>
                            </div>
                            <div class="col-sm-3">
                                <label for="">{{ translate('messages.Minimum delivery charge') }}
                                    ({{ \App\CentralLogics\Helpers::currency_symbol() }})</label>
                            </div>
                            <div class="col-sm-3">
                                <label for="">{{ translate('maximum_cod_order_amount') }}
                                    ({{ \App\CentralLogics\Helpers::currency_symbol() }})</label>
                            </div>
                        </div>
                                ...
                                @if ($module->module_type == 'parcel')
                                    <div class="row gy-1 module-row" id="module_{{ $module->id }}">
                                        ...
                                        <div class="col-sm-3"><input type="number" class="form-control"
                                                ...
                                                data-original-title="{{ translate('messages.You have to set category wise charge from parcel category') }}"
                                                readonly></div>
                                ...
                                @else
                                    <div class="row gy-1 module-row" id="module_{{ $module->id }}">
                                        ...
                                        <div class="col-sm-3"><input type="number" class="form-control"
                                                name="module_data[{{ $module->id }}][per_km_shipping_charge]"
                                                step=".01" min="0"
                                                placeholder="{{ translate('messages.per_km_delivery_charge') }}"
