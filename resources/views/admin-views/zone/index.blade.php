                            ...
                            <div class="pl-xl-5 pl-xxl-0">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control"
                                        placeholder="{{ translate('messages.new_zone') }}" value="{{ old('name') }}"
                                        required>
                                </div>
                ...
                <div class="card">
                    <div class="card-header py-2 border-0">
                        <div class="search--button-wrapper">
                            <h5 class="card-title">
                                {{ translate('messages.zone') }} {{ translate('messages.list') }}<span
                                    class="badge badge-soft-dark ml-2" id="itemCount">{{ $zones->total() }}</span>
                            </h5>
                            <form action="javascript:" id="search-form" class="search-form">
                                ...
                                <div class="input-group input--group">
                                    <input id="datatableSearch_" type="search" name="search" class="form-control"
                                        placeholder="{{ translate('messages.ex_:_search_name') }}"
                            ...
                            <div class="hs-unfold mr-2">
                                ...
                                <div id="usersExportDropdown"
                                    ...
                                    <a id="export-excel" class="dropdown-item"
                                        href="{{ route('admin.zone.export', ['type' => 'excel']) }}">
                                        <img class="avatar avatar-xss avatar-4by3 mr-2"
                                    ...
                                    <a id="export-csv" class="dropdown-item"
                                        href="{{ route('admin.zone.export', ['type' => 'csv']) }}">
                                        <img class="avatar avatar-xss avatar-4by3 mr-2"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <label class="toggle-switch toggle-switch-sm"
                                                ...
                                                <input type="checkbox"
                                                    onclick="status_form_alert('status-{{ $zone['id'] }}','{{ translate('Want to change status for this zone ?') }}', event)"
                                        ...
                                        <td>
                                            <label class="toggle-switch toggle-switch-sm"
                                                ...
                                                <input type="checkbox"
                                                    onclick="status_form_alert('digital_payment-{{ $zone['id'] }}','{{ translate('Want to change digital payment for this zone ?') }}', event)"
                                            ...
                                            <form
                                                action="{{ route('admin.zone.digital-payment', [$zone['id'], $zone->digital_payment ? 0 : 1]) }}"
                                        ...
                                        <td>
                                            <label class="toggle-switch toggle-switch-sm"
                                                ...
                                                <input type="checkbox"
                                                    onclick="status_form_alert('cash_on_delivery-{{ $zone['id'] }}','{{ translate('Want to change cash on delivery for this zone ?') }}', event)"
                                                    class="toggle-switch-input"
                                            ...
                                            <form
                                                action="{{ route('admin.zone.cash-on-delivery', [$zone['id'], $zone->cash_on_delivery ? 0 : 1]) }}"
                                        ...
                                        <td>
                                            <div class="btn--container justify-content-center">
                                                <a class="btn action-btn btn--primary btn-outline-primary"
                                                    href="{{ route('admin.business-settings.zone.edit', [$zone['id']]) }}"
                                                    title="{{ translate('messages.edit') }} {{ translate('messages.zone') }}"><i
                                                        class="tio-edit"></i>
                                                </a>
                                                <a class="btn action-btn btn--warning btn-outline-warning"
                                                    title="Module Setup"
                                                    href="{{ route('admin.business-settings.zone.module-setup', [$zone['id']]) }}"><i
                                                        class="tio-settings"></i>
                                                </a>
                                                <a class="btn action-btn btn--danger btn-outline-danger"
                                                    href="javascript:"
                                                    onclick="form_alert('zone-{{ $zone['id'] }}','{{ translate('Want to delete this zone ?') }}')"
                                                    title="{{ translate('messages.delete') }} {{ translate('messages.zone') }}"><i
