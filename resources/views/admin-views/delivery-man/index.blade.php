    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-header-title text-break">
                ...
                <span>{{ translate('messages.add') }} {{ translate('messages.new') }}
                    {{ translate('messages.deliveryman') }}</span>
            </h1>
        </div>
        <!-- End Page Header -->
                    ...
                    <div class="row g-4">
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <select name="zone_id" class="form-control" required
                                            ...
                                            <option value="" readonly="true" hidden="true">
                                                {{ translate('messages.select') }} {{ translate('messages.zone') }}
                                            </option>
                        ...
                        <div class="col-lg-4">
                            <div class="d-flex flex-column h-100">
                                <label class="text-center">{{ translate('messages.deliveryman') }}
                                    {{ translate('messages.image') }} <small class="text-danger">* (
                                        {{ translate('messages.ratio') }} 1:1 )</small></label>
                                <center class="py-3 my-auto">
                                    <img class="img--100" id="viewer" src="{{ asset('assets/admin/img/admin.png') }}"
                                ...
                                <div class="col-sm-6 col-lg-12">
                                    <div class="form-group mb-0">
                                        ...
                                        <select name="identity_type" class="form-control">
                                            ...
                                            <option value="store_id">{{ translate('messages.store') }}
