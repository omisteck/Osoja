...
@section('content')
    <div class="content container-fluid">
        ...
        <!-- End Page Header -->
        <form action="{{ route('admin.users.delivery-man.update', [$delivery_man['id']]) }}" method="post"
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-4">
                            <div class="d-flex flex-column h-100">
                                <label>{{ translate('messages.deliveryman') }} {{ translate('messages.image') }} <small
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <select name="identity_type" class="form-control">
                                            ...
                                            <option value="store_id"
                                                {{ $delivery_man['identity_type'] == 'store_id' ? 'selected' : '' }}>
                        ...
                        <div class="col-lg-8">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <label class="input-label"
                                        for="exampleFormControlInput1">{{ translate('messages.update') }}
                                        {{ translate('messages.identity') }} {{ translate('messages.image') }}</label>
                                    <div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group mb-0">
                                ...
                                <input type="text" id="phone" name="phone"
                                    value="{{ $delivery_man['phone'] }}" class="form-control"
...
@push('script_2')
    ...
    <script>
        $('#reset_btn').click(function() {
            $('#viewer').attr('src',
                '{{ asset('storage/delivery-man') }}/{{ $delivery_man['image'] }}');
