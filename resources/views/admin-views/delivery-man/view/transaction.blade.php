                ...
                <div class="search--button-wrapper">
                    ...
                    <div class="min--260">
                        <input type="date" class="form-control"
                            onchange="set_filter('{{ route('admin.delivery-man.preview', ['id' => $dm->id, 'tab' => 'transaction']) }}',this.value, 'date')"
                            value="{{ $date }}">
                    </div>
                </div>
            </div>
                    ...
                    <table id="datatable"
                        ...
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="border-0">{{ translate('messages.delivery_fee') }}
                                    {{ translate('messages.earned') }}</th>
                        ...
                        <tbody>
                            <?php
    $digital_transaction = \App\Models\OrderTransaction::where('delivery_man_id', $dm->id)->when($date, function ($query) use ($date) {
