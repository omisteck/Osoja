            ...
            <div class="row g-3">
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="card h-100">
                        ...
                        <!-- Body -->
                        <div class="card-body p-0 initial-19" style="overflow-y: scroll;height: 600px"
...
@push('script_2')
    <script>
        function viewConvs(url, id_to_active, conv_id, sender_id) {
            ...
            let new_url = "{{ route('admin.users.delivery-man.preview', ['id' => $dm->id, 'tab' => 'conversation']) }}" +
        ...
        $('#dm-conversation-list').scroll(function() {
            if ($('#dm-conversation-list').scrollTop() + $('#dm-conversation-list').height() >= $(
