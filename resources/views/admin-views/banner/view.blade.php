                    ...
                    <div class="table-responsive datatable-custom">
                        <table id="columnSearchDatatable"
                            ...
                            <thead class="thead-light">
                                ...
                                <tr>
                                    <th colspan="3">
                                        <form action="{{ route('admin.banner.addstore', $banner->id) }}"
                                            id="store-add-form" method="POST">
                                            @csrf
                                            <!-- Search -->
                                            <div class="row">
                                                <div class="input-group-prepend col-md-7">
                                                    ...
                                                    <select name="store_id" id="store_id" class="form-control">
                                                        ...
                                                        @empty
                                                            <option value="">
                                                                {{ translate('messages.no_data_found') }}</option>
                                                        @endforelse
                                                    </select>
                                                </div>
                                                <button type="submit"
                                                    class="btn btn--primary col-md-5">{{ translate('messages.add') }}
                                        ...
                                        <form action="javascript:" id="search-form">
                                            ...
                                            <div class="input-group input--group">
                                                <input id="datatableSearch_" type="search" name="search"
                                                    class="form-control" placeholder="{{ translate('messages.search') }}"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="inline--2"
                                                ...
                                                <span
                                                    class="legend-indicator bg-danger"></span>{{ translate('messages.remove') }}
                                            </div>
                                            <!-- End Dropdown -->
                                        </td>
                                    </tr>
