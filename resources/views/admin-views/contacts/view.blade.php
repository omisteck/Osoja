                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body d-flex flex-column gap-2">
                            ...
                            <ul class="list-group mb-3">
                                ...
                                <li class="list-group-item"><strong>{{ translate('messages.Subject') }}: </strong>
                                    <strong>{{ $contact->subject }}</strong>
                                </li>
                                <li class="list-group-item"><strong>{{ translate('messages.Message') }}:
                                    </strong><strong>{{ $contact->message }}</strong></li>
                            </ul>
                            <h5 class="px-2 py-1 badge-soft-warning rounded mb-3 d-flex">{{ translate('messages.admin') }}
                            </h5>
                            @if ($contact['reply'] != null)
                                ...
                                <ul class="list-group mb-3">
                                    ...
                                    <li class="list-group-item"><strong>{{ translate('messages.Message') }}:
                                        </strong><strong>{{ $data['body'] }}</strong></li>
                                </ul>
                            @else
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <center>
                                        ...
                                        <label
                                            class="badge-soft-danger px-1">{{ translate('messages.Configure_your_mail_setup_first') }}.</label>
                                    </center>


                                    <form action="{{ route('admin.users.contact.contact-send-mail', $contact->id) }}"
                                        method="post">
                                        @csrf
                                        <div class="form-group mt-2">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 mt-3">
                                                    <label
                                                        class="title-color">{{ translate('messages.Mail_Body') }}</label>
                                                    <textarea class="form-control h-100" name="mail_body" placeholder="{{ translate('messages.Please_send_a_Feedback') }}"
                                                        required></textarea>
                                                </div>
                                            </div>
                                        </div>
