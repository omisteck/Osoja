                                    ...
                                    <div class="{{ $lang != $default_lang ? 'd-none' : '' }} lang_form"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name[]" id="{{ $lang }}_name"
                                                ...
                                                value="{{ $translate[$lang]['name'] ?? $parcel_category['name'] }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" name="description[]" class="form-control ckeditor"
                                                {{ $lang == $default_lang ? 'required' : '' }} oninvalid="document.getElementById('en-link').click()">{!! $translate[$lang]['description'] ?? $parcel_category['description'] !!}</textarea>
                                        </div>
                                    </div>
                                @endforeach
                            @else
                        ...
                        <div class="col-lg-6">
                            <div class="h-100 d-flex flex-column">
                                ...
                                <center class="py-3 my-auto">
                                    <img class="img--130" id="viewer"
                                        src="{{ asset('storage/parcel_category') }}/{{ $parcel_category['image'] }}"
                                        alt=""
