                            ...
                            @if ($language)
                                @foreach (json_decode($language) as $lang)
                                    <div class="{{ $lang != $default_lang ? 'd-none' : '' }} lang_form"
                                        ...
                                        <div class="form-group">
                                            <label class="input-label" for="description">{{ translate('messages.short') }}
                                                {{ translate('messages.description') }} ({{ strtoupper($lang) }})</label>
                                            <textarea type="text" name="description[]" class="form-control ckeditor"
                                                {{ $lang == $default_lang ? 'required' : '' }} oninvalid="document.getElementById('en-link').click()"></textarea>
                                        </div>
                                    </div>
                                @endforeach
                            @else
                    ...
                    <table id="columnSearchDatatable"
                        ...
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="border-0 text-center">{{ translate('messages.orders') }}
                                    {{ translate('messages.count') }}</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label class="toggle-switch toggle-switch-sm"
                                            ...
                                            <input type="checkbox"
                                                onclick="location.href='{{ route('admin.parcel.category.status', [$category['id'], $category->status ? 0 : 1]) }}'"class="toggle-switch-input"
