            ...
            <div class="card-body">
                <form action="{{ route('admin.coupon.update', [$coupon['id']]) }}" method="post">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4 col-lg-3 col-sm-6">
                            <div class="form-group m-0">
                                ...
                                <select name="module_id" required class="form-control js-select2-custom"
                                    ...
                                    id="module_select" disabled>
                                    @foreach (\App\Models\Module::notParcel()->get() as $module)
                                        <option value="{{ $module->id }}"
                                            {{ $module->id == $coupon->module_id ? 'selected' : '' }}>{{ $module->module_name }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group m-0">
                                ...
                                <select name="coupon_type" class="form-control" onchange="coupon_type_change(this.value)">
                                    <option value="store_wise" {{ $coupon['coupon_type'] == 'store_wise' ? 'selected' : '' }}>
                                        {{ translate('messages.store') }} {{ translate('messages.wise') }}</option>
                                    <option value="zone_wise" {{ $coupon['coupon_type'] == 'zone_wise' ? 'selected' : '' }}>
                                        {{ translate('messages.zone') }} {{ translate('messages.wise') }}</option>
                                    ...
                                    <option value="first_order" {{ $coupon['coupon_type'] == 'first_order' ? 'selected' : '' }}>
                                        {{ translate('messages.first') }} {{ translate('messages.order') }}</option>
                        ...
                        <div class="col-md-4 col-lg-3 col-sm-6">
                            <div class="form-group m-0">
                                <label class="input-label" for="limit">{{ translate('messages.limit') }}
                        ...
                        <div class="col-md-4 col-lg-3 col-sm-6">
                            <div class="form-group m-0">
                                <label class="input-label" for="">{{ translate('messages.start') }}
                        ...
                        <div class="col-md-4 col-lg-3 col-sm-6">
                            <div class="form-group m-0">
                                <label class="input-label" for="date_to">{{ translate('messages.expire') }}
                                    {{ translate('messages.date') }}</label>
                        ...
                        <div class="col-md-4 col-lg-3 col-sm-6">
                            <div class="form-group m-0">
                                <label class="input-label" for="discount_type">{{ translate('messages.discount') }}
                                    {{ translate('messages.type') }}</label>
                        ...
                        <div class="col-md-4 col-lg-3 col-sm-6">
                            <div class="form-group m-0">
                                <label class="input-label" for="exampleFormControlInput1">{{ translate('messages.max') }}
                        ...
                        <div class="col-md-4 col-lg-3 col-sm-6">
                            <div class="form-group m-0">
                                <label class="input-label" for="exampleFormControlInput1">{{ translate('messages.min') }}
