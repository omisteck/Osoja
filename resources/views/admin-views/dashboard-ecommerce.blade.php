                ...
                <div class="row align-items-center py-2">
                    <div class="col-sm mb-2 mb-sm-0">
                        <div class="d-flex align-items-center">
                            <img onerror="this.src='{{ asset('/assets/admin/img/eshop.svg') }}'"
                    ...
                    <div class="row g-2" id="order_stats">
                        <div class="col-sm-6 col-lg-3">
                            <div class="__dashboard-card-2">
                                <img src="{{ asset('/assets/admin/img/dashboard/stats/products.svg') }}"
                                    alt="dashboard/stats">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="__dashboard-card-2">
                                <img src="{{ asset('/assets/admin/img/dashboard/stats/orders.svg') }}"
                                    alt="dashboard/stats">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="__dashboard-card-2">
                                <img src="{{ asset('/assets/admin/img/dashboard/stats/stores.svg') }}"
                                    alt="dashboard/stats">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="__dashboard-card-2">
                                <img src="{{ asset('/assets/admin/img/dashboard/stats/customers.svg') }}"
                                    alt="dashboard/stats">
