                ...
                <div class="row align-items-center py-2">
                    <div class="col-sm mb-2 mb-sm-0">
                        <div class="d-flex align-items-center">
                            <img onerror="this.src='{{ asset('/assets/admin/img/grocery.svg') }}'"
                            ...
                            <div class="statistics-btn-grp">
                                <label>
                                    <input type="radio" name="statistics" value="this_year"
                                        {{ $params['statistics_type'] == 'this_year' ? 'checked' : '' }} hidden
                                        onchange="order_stats_update(this.value)">
                                    <span>This Year</span>
                                </label>
                                <label>
                                    <input type="radio" name="statistics" value="this_month"
                                        {{ $params['statistics_type'] == 'this_month' ? 'checked' : '' }} hidden
                                        onchange="order_stats_update(this.value)">
                                    <span>This Month</span>
                                </label>
                                <label>
                                    <input type="radio" name="statistics" value="this_week"
                                        {{ $params['statistics_type'] == 'this_week' ? 'checked' : '' }} hidden
                                        onchange="order_stats_update(this.value)">
                                    <span>This Week</span>
                                </label>
                            </div>
                    ...
                    <div class="row g-2" id="order_stats">
                        <div class="col-sm-6 col-lg-3">
                            <div class="__dashboard-card-2">
                                <img src="{{ asset('/assets/admin/img/dashboard/pharmacy/items.svg') }}"
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="__dashboard-card-2">
                                <img src="{{ asset('/assets/admin/img/dashboard/pharmacy/orders.svg') }}"
                                    alt="dashboard/pharmacy">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="__dashboard-card-2">
                                <img src="{{ asset('/assets/admin/img/dashboard/pharmacy/stores.svg') }}"
                                    alt="dashboard/pharmacy">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="__dashboard-card-2">
                                <img src="{{ asset('/assets/admin/img/dashboard/pharmacy/customers.svg') }}"
                                    alt="dashboard/pharmacy">
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-sm-6 col-lg-3">
                                    <a class="order--card h-100" href="{{ route('admin.order.list', ['accepted']) }}">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                                                <img src="{{ asset('/assets/admin/img/dashboard/grocery/accepted.svg') }}"
                                                    alt="dashboard" class="oder--card-icon">
                                ...
                                <div class="col-sm-6 col-lg-3">
                                    <a class="order--card h-100" href="{{ route('admin.order.list', ['processing']) }}">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                                                <img src="{{ asset('/assets/admin/img/dashboard/grocery/packaging.svg') }}"
                                                    alt="dashboard" class="oder--card-icon">
                                ...
                                <div class="col-sm-6 col-lg-3">
                                    <a class="order--card h-100" href="{{ route('admin.order.list', ['refunded']) }}">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <h6
                                                class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                                                <img src="{{ asset('/assets/admin/img/order-status/refunded.svg') }}"
                                                    alt="dashboard" class="oder--card-icon">
                                ...
                                <div class="col-sm-6 col-lg-3">
                                    <a class="order--card h-100" href="{{ route('admin.order.list', ['failed']) }}">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <h6
                                                class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                                                <img src="{{ asset('/assets/admin/img/order-status/payment-failed.svg') }}"
                                                    alt="dashboard" class="oder--card-icon">
                                                <span>{{ translate('messages.payment') }}
                                                    {{ translate('messages.failed') }}</span>
                                            </h6>
                                            <span class="card-title text-danger">
                        ...
                        <div class="card-body">
                            <div class="d-flex flex-wrap justify-content-between align-items-center __gap-12px">
                                ...
                                <select class="custom-select border-0 text-center w-auto ml-auto"
                                    name="commission_overview" onchange="commission_overview_stats_update(this.value)">
